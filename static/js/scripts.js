...
!(function (e) {
  ...
  (function (e, n, o) {
    ...
    var E = {},
      ...
      b =
        /rident/.test(h) ||
        (/ecko/.test(h) && h.match(/rv\:(\d+)/) && 35 < RegExp.$1),
      T = "currentSrc",
      g = /\s+\+?\d+(e\d+)?w/,
      v = /(\([^)]+\))?\s*(.+)/,
      w = e.picturefillCFG,
    ...
    var H,
      ...
      ie =
        ...
        (F = Q(function (e) {
          return (
            "return " +
            (function () {
              for (var e = arguments, t = 0, s = e[0]; ++t in e; )
                s = s.replace(e[t], e[++t]);
              return s;
            })(
              (e || "").toLowerCase(),
      ...
      ne = function (e, t) {
        return (
          e.w
            ? ((e.cWidth = E.calcListLength(t || "100vw")),
              (e.res = e.w / e.cWidth))
            : (e.res = e.d),
          e
        );
        ...
        if (c) {
          ...
          if (
            ...
            (r = (t =
              ...
              E.qsa(
                i.context || n,
                i.reevaluate || i.reselect ? E.sel : E.selShort
              )).length))
          ) {
    ...
    e.console && console.warn,
      ...
      (r["image/gif"] = !0),
      (r["image/png"] = !0),
      (r["image/svg+xml"] = n.implementation.hasFeature(
      ...
      E.supSrcset &&
        ...
        (s.srcset = "data:,a"),
        (N.src = "data:,a"),
        (E.supSrcset = s.complete === N.complete),
        (E.supPicture = E.supSrcset && E.supPicture)),
      E.supSrcset && !E.supSizes
        ? ((O =
            "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),
          (j = function () {
            2 === q.width && (E.supSizes = !0),
              (l = E.supSrcset && !E.supSizes),
              (c = !0),
              setTimeout(ce);
          }),
              ...
              function u() {
                for (e(D), t = "", s = "in descriptor"; ; ) {
                  if (((i = r.charAt(c)), "in descriptor" === s))
                    if (G(i))
                      t && (p.push(t), (t = ""), (s = "after descriptor"));
                    else {
          ...
          var e = E.calcLength(
            (function (e) {
              ...
              for (
                ...
                if (
                  ((a = n = (i = s[t])[i.length - 1]),
                  (u.test(a) && 0 <= parseFloat(a)) ||
                    o.test(a) ||
                    "0" === a ||
                    "-0" === a ||
                    "+0" === a)
      ...
      (E.setRes = function (e) {
        var t;
        if (e)
          for (var s = 0, r = (t = E.parseSet(e)).length; s < r; s++)
            ne(t[s], e.sizes);
        return t;
      }),
      (E.setRes.res = ne),
        ...
        if (e.length) {
          ...
          if (
            ...
            (u =
              ...
              !(p = e[0].set) &&
                d &&
                (p = (p = f[E.ns].sets) && p[p.length - 1]),
              (A = ue(d, p)) &&
                ((d = E.makeUrl(d)),
                (f[E.ns].curSrc = d),
                (f[E.ns].curCan = A).res || ne(A, A.set.sizes)),
              A)) &&
              u.set === e[0].set &&
              ((l = b && !t.complete && u.res - 0.1 > y) ||
                ((u.cached = !0), u.res >= y && (c = u))),
            !c)
          )
            for (e.sort(ae), c = e[(n = e.length) - 1], r = 0; r < n; r++)
              if ((s = e[r]).res >= y) {
                c =
                  ...
                  (S = w = void 0),
                  g <
                    ("saveData" === z.algorithm
                      ? 2.7 < m
                        ? g + 1
                        : ((S = (h - g) * (w = Math.pow(m - 0.6, 1.5))),
                          v && (S += 0.1 * w),
                          m + S)
                      : 1 < g
                      ? Math.sqrt(m * h)
      ...
      (E.setSrc = function (e, t) {
        ...
        (e.src = t.url),
          "image/svg+xml" === t.set.type &&
            ...
            e.offsetWidth + 1 && (e.style.width = s));
      }),
      (E.getSet = function (e) {
        var t,
          s,
        ...
        for (t = 0; t < n.length && !i; t++)
          if (
            (s = n[t]).srcset &&
            E.matchesMedia(s.media) &&
            (r = E.supportsType(s.type))
          ) {
            "pending" === r && (s = r), (i = s);
            break;
          }
      ...
      (E.parseSets = function (e, t, s) {
        ...
        (u.src === o || s.src) &&
          ((u.src = f.call(e, "src")),
          u.src ? d.call(e, A, u.src) : p.call(e, A)),
          (u.srcset === o || s.srcset || !E.supSrcset || e.srcset) &&
            ((r = f.call(e, "srcset")), (u.srcset = r), (c = !0)),
          (u.sets = []),
          a &&
            ((u.pic = !0),
            (function (e, t) {
          ...
          u.srcset
            ? ((i = { srcset: u.srcset, sizes: f.call(e, "sizes") }),
              u.sets.push(i),
              (n = (l || u.src) && g.test(u.srcset || "")) ||
                !u.src ||
                ue(u.src, i) ||
                i.has1x ||
                ((i.srcset += ", " + u.src),
                i.cands.push({ url: u.src, d: 1, set: i })))
          ...
          c &&
            E.supSrcset &&
            !u.supported &&
            (r ? (d.call(e, m, r), (e.srcset = "")) : p.call(e, m)),
          u.supported &&
            !u.srcset &&
            ((!u.src && e.src) || e.src !== E.makeUrl(u.src)) &&
        ...
        e[E.ns] || (e[E.ns] = {}),
          ...
          (a || s.evaled !== u) &&
            ...
            s.supported
              ...
              : ((r = e),
                (c = !1),
                "pending" !== (n = E.getSet(r)) &&
                  ((c = u),
                  n && ((i = E.setRes(n)), E.applySetCandidate(i, r))),
                (r[E.ns].evaled = c)));
      }),
      (E.setupRun = function () {
      ...
      E.supPicture
        ...
        : ((Y = e.attachEvent ? /d$|^c/ : /d$|^c|^i/),
          (Z = function () {
            var e = n.readyState || "";
            (ee = setTimeout(Z, "loading" === e ? 200 : 999)),
              n.body &&
                (E.fillImgs(), (V = V || Y.test(e)) && clearTimeout(ee));
          }),
          ...
          W(
            ...
            ((_ = function () {
              (x =
                Math.max(e.innerWidth || 0, a.clientWidth) !== L.width ||
                a.clientHeight !== te),
                (te = a.clientHeight),
                x && E.fillImgs();
            }),
      ...
      (e.picturefillCFG = {
        ...
        push: function (e) {
          ...
          "function" == typeof E[t]
            ? E[t].apply(E, e)
            : ((z[t] = e[0]), P && E.fillImgs({ reselect: !0 }));
        },
      });
...
(function () {
  ...
  function r(i) {
    return function (n, r, t) {
      r = x(r, t);
      for (var e = O(n), u = 0 < i ? 0 : e - 1; 0 <= u && u < e; u += i)
  ...
  (m.each = m.forEach =
    ...
    (m.max = function (n, e, r) {
      var t,
        ...
        o = -1 / 0;
      if (null == e && null != n)
        for (var a = 0, c = (n = k(n) ? n : m.values(n)).length; a < c; a++)
          (t = n[a]), i < t && (i = t);
      else
        (e = x(e, r)),
          m.each(n, function (n, r, t) {
        ...
        return (
          ...
          r <= 0 || e < r
            ? (c && (clearTimeout(c), (c = null)),
              ...
              (a = t.apply(i, o)),
              c || (i = o = null))
            : c || !1 === u.trailing || (c = setTimeout(l, r)),
          a
        );
      };
    }),
    (m.debounce = function (r, t, e) {
      var u,
        ...
        f = function () {
          ...
          n < t && 0 <= n
            ? (u = setTimeout(f, t - n))
            : ((u = null), e || ((c = r.apply(o, i)), u || (o = i = null)));
        };
      return function () {
  ...
  (m.keys = function (n) {
    ...
    (m.values = function (n) {
      for (var r = m.keys(n), t = r.length, e = Array(t), u = 0; u < t; u++)
        e[u] = n[r[u]];
      return e;
    }),
    (m.mapObject = function (n, r, t) {
      r = x(r, t);
      for (var e, u = m.keys(n), i = u.length, o = {}, a = 0; a < i; a++)
        o[(e = u[a])] = r(n[e], e, n);
      return o;
    }),
    (m.pairs = function (n) {
    ...
    (m.invert = function (n) {
      for (var r = {}, t = m.keys(n), e = 0, u = t.length; e < u; e++)
        r[n[t[e]]] = t[e];
      return r;
    }),
...
!(function (n) {
  ...
  var n = function (i, t, n) {
    ...
    c = function (t, e, i, n, s) {
      ...
      if (i && "object" == typeof i) {
        ...
        for (r = i.split(u); a < r.length; a++) e = t(e, r[a], n, s);
      else e = t(e, i, n, s);
      return e;
    };
  o.on = function (t, e, i) {
  ...
  var l = function (t, e, i, n, s) {
    return (
      (t._events = c(d, t._events || {}, e, i, {
        context: n,
        ctx: t,
        listening: s,
      })),
      s && ((t._listeners || (t._listeners = {}))[s.id] = s),
      t
    );
  };
  ...
  (o.off = function (t, e, i) {
    return (
      this._events &&
        (this._events = c(f, this._events, t, e, {
          context: i,
        ...
        for (var h = e ? [e] : x.keys(t); r < h.length; r++) {
          ...
          for (var c = [], l = 0; l < u.length; l++) {
            ...
            (a && a !== d.context)
              ...
              : (s = d.listening) &&
                0 == --s.count &&
                (delete o[s.id], delete s.listeningTo[s.objId]);
          }
          c.length ? (t[e] = c) : delete t[e];
        }
        return t;
      }
      for (var f = x.keys(o); r < f.length; r++)
        delete o[(s = o[f[r]]).id], delete s.listeningTo[s.objId];
    }
  };
  ...
  x.extend(m.prototype, o, {
    ...
    set: function (t, e, i) {
      ...
      for (var l in n)
        (e = n[l]),
          x.isEqual(h[l], e) || a.push(l),
          x.isEqual(c[l], e) ? delete u[l] : (u[l] = e),
          s ? delete h[l] : (h[l] = e);
      if (
    ...
    destroy: function (e) {
      ...
      var i = this,
        ...
        t = !(e.success = function (t) {
          s && r(),
            n && n.call(e.context, i, t, e),
            i.isNew() || i.trigger("sync", i, t, e);
        });
      return (
        this.isNew()
          ? x.defer(e.success)
          : (O(this, e), (t = this.sync("delete", this, e))),
        s || r(),
        t
      );
    },
    url: function () {
      var t =
        x.result(this, "urlRoot") || x.result(this.collection, "url") || M();
  ...
  x.extend(_.prototype, o, {
      ...
      if (null != t) {
          ...
          if (m) {
            if (d && s !== m) {
              ...
              e.parse && (_ = m.parse(_, e)),
                m.set(_, e),
                h.push(m),
                p && !g && (g = m.hasChanged(v));
            }
            c[m.cid] || ((c[m.cid] = !0), a.push(m)), (t[r] = m);
          } else
            l &&
              (s = t[r] = this._prepareModel(s, e)) &&
              (o.push(s), this._addReference(s, e), (c[s.cid] = !0), a.push(s));
        }
        if (f) {
          for (r = 0; r < this.length; r++)
            c[(s = this.models[r]).cid] || u.push(s);
        ...
        if (
          (a.length && b
            ...
            : o.length &&
              (p && (g = !0),
              E(this.models, o, null == n ? this.length : n),
              (this.length = this.models.length)),
          ...
          for (r = 0; r < o.length; r++)
            null != n && (e.index = n + r),
              (s = o[r]).trigger("add", s, this, e);
          (g || y) && this.trigger("sort", this, e),
            (o.length || u.length || h.length) &&
              ((e.changes = { added: o, removed: u, merged: h }),
              this.trigger("update", this, e));
        }
        return i ? t[0] : t;
      }
    ...
    sort: function (t) {
      ...
      var i = e.length;
      return (
        x.isFunction(e) && (e = x.bind(e, this)),
        1 === i || x.isString(e)
  ...
  var C = (h.History = function () {
      (this.handlers = []),
        (this.checkUrl = x.bind(this.checkUrl, this)),
  ...
  (C.started = !1),
    x.extend(C.prototype, o, {
      ...
      navigate: function (t, e) {
        ...
        var n = i + t;
        if (
          ((t = this.decodeFragment(t.replace(N, ""))), this.fragment !== t)
        ) {
...
"classList" in document.documentElement ||
        ...
        for (var o in ((i = !1), t))
          r[o] =
            ...
            a.test(t[o])
              ...
              : t[o];
        return (
          (((e.prototype = r).constructor = e).extend = arguments.callee), e
        );
      }),
      "function" == typeof define &&
        define.amd &&
  ...
  Array.prototype.indexOf ||
    (Array.prototype.indexOf = function (t) {
      ...
      for (
        (r = r < 0 ? Math.ceil(r) : Math.floor(r)) < 0 && (r += e);
        r < e;
        r++
      )
  ...
  ((relax = {
    ...
    tools: {},
    displayObject: {},
  }).geom.lineDistance = function (t, e) {
    var r = 0,
      o = 0;
    return (
      (r = e.x - t.x), (r *= r), (o = e.y - t.y), (o *= o), Math.sqrt(r + o)
    );
  }),
  ...
  (relax.geom.getDistanceFromLatLonInKm = function (t, e, r, o) {
    var n = relax.geom.degToRad(r - t),
      ...
      a =
        ...
        Math.cos(relax.geom.degToRad(t)) *
          Math.cos(relax.geom.degToRad(r)) *
          Math.sin(i / 2) *
          Math.sin(i / 2);
  ...
  (relax.dom.bindSelect = function (t, e, r) {
    var o =
        relax.browser.getInternetExplorerVersion() <= 8 &&
        -1 !== relax.browser.getInternetExplorerVersion(),
      n = r;
    o
      ? $(t).bind("propertychange", function (t) {
          "propertychange" == t.type &&
            "value" == event.propertyName.toLowerCase() &&
            ((t.target.selectedIndex = this.selectedIndex), n(t));
        })
  ...
  (relax.tools.checkInterface = function (t, e) {
    for (var r in e)
      if (typeof t[r] != typeof e[r])
        return log("object failed to implement interface member " + r), !1;
    return !0;
  }),
          ...
          (window.log = function () {
            ...
            if (
              ...
              if (
                ...
                1 === Array.prototype.slice.call(n).length &&
                "string" == typeof Array.prototype.slice.call(n)[0]
                  ? console.log(Array.prototype.slice.call(n).toString())
      ...
      : (window.log = function () {
          if (
            ...
            (e.callee = e.callee.caller),
              (t = [].slice.call(e)),
              "object" == typeof console.log
                ? log.apply.call(console.log, console, t)
    ...
    t.query = function (t, e) {
      if (((e = e || o), n.test(t)))
        switch (t.charAt(0)) {
          ...
          case ".":
            return (
              (r = t.substr(1).replace(i, " ")),
              a.call(e.getElementsByClassName(r))
            );
          default:
  ...
  (relax.array.equalInPercent = function (t, e) {
    if (!e) return 0;
    for (
      var r = (100 / t.length) * 0.01, o = 0, n = 0, i = t.length;
      n < i;
      n++
    )
      t[n] == e[n] && n < e.length && (o += r);
    return o;
  }),
    ...
    var o,
      n =
        Math.floor(
          (this.getTime() -
            e.getTime() -
            6e4 * (this.getTimezoneOffset() - e.getTimezoneOffset())) /
            864e5
        ) + 1;
    return (
      r < 4
        ? 52 < (o = Math.floor((n + r - 1) / 7) + 1) &&
          ((nYear = new Date(this.getFullYear() + 1, 0, 1)),
          (nday = nYear.getDay() - t),
          (nday = 0 <= nday ? nday : nday + 7),
          (o = nday < 4 ? 1 : 53))
  ...
  HTMLElement.prototype.index ||
    (HTMLElement.prototype.index = function () {
      for (var t = this, e = t.parentNode, r = 0; t.previousElementSibling; )
  ...
  (relax.browser.isFirefox = function () {
    return (
      0 < navigator.userAgent.lastIndexOf("Firefox/") &&
      Number(
        navigator.userAgent.match(
          /Firefox\/([1]{1}[7-9]{1}|[2-9]{1}[0-9]{1})/
        )[1]
      )
    );
  }),
  ...
  (relax.browser.getMouseEvent = function (t) {
    ...
    return (
      (e.mousedown =
        "ontouchstart" in window && relax.browser.isTouch()
          ? "touchstart"
          : "mousedown"),
      (e.mouseup =
        "ontouchstart" in window && relax.browser.isTouch()
  ...
  (relax.caniuse.localstorage = function () {
    try {
      return (
        localStorage.setItem("rwatgg_hello_storage", "mod"),
  ...
  (relax.caniuse.cssBlendmodes = function () {
    try {
      if ("CSS" in window && "supports" in window.CSS)
        return window.CSS.supports("mix-blend-mode", "soft-light");
    } catch (t) {
      return !1;
    }
    return !1;
  ...
  (relax.caniuse.mp4 = function () {
    return (
      "boolean" == typeof this._mp4Supported ||
        (this._mp4Supported = !!document
          .createElement("video")
  ...
  (relax.caniuse.cssgradients = function () {
    ...
    var t = "background-image:",
      ...
      r = (
        ...
        e.join("linear-gradient(left top,#9f9, white);" + t)
      ).slice(0, -t.length),
      o = document.createElement("div").style;
    return (
      (o.cssText = r),
      (this.cssGradientSupported =
        -1 < ("" + o.backgroundImage).indexOf("gradient")),
      this.cssGradientSupported
    );
  }),
  ...
  (relax.caniuse.flexbox = function () {
    ...
    try {
      (o.style.display = r),
        (o.style.display = e),
        (o.style.display == e || o.style.display == r) && (t = !0);
    } catch (o) {
      t = !1;
    }
    return t;
  ...
  (relax.color.rgb2hex = function (t, e, r, o, n) {
    ...
    return (
      ...
      n
        ? (o << 24) | (t << 16) | (e << 8) | r
        : (o <= 1 && (o = Math.round(255 * o)), "#" + i(t) + i(e) + i(r))
    );
  }),
  ...
  (relax.color.similar = function (t, e, r) {
    ...
    var i = 0;
    return (
      (i += Math.pow(o.red - n.red, 2)),
      (i += Math.pow(o.green - n.green, 2)),
      (i += Math.pow(o.blue - n.blue, 2)) <= r
    );
  }),
  (relax.color.different = function (t, e, r) {
    r || (r = 0.01);
    for (var o = 0; o < e.length; o++)
      if (relax.color.similar(t, e[o], r)) return !1;
    return !0;
  }),
  (relax.color.uniqueColours = function (t, e, r) {
    r || (r = 0.01);
    for (var o = [], n = 0; n < t.length && o.length < e; n++)
      relax.color.different(t[n], o, r) && o.push(t[n]);
    return o;
  }),
  (relax.color.indexColours = function (t, e) {
    ...
    for (
      var r,
        o = t.getContext("2d").getImageData(0, 0, t.width, t.height).data,
        n = [],
        i = 0,
        a = o.length;
      i < a;
      ...
      (r = relax.color.rgb2hex(o[i], o[i + 1], o[i + 2])),
        n.push({ colour: r, count: n.length });
    return e
      ? n.sort(function (t, e) {
  ...
  (relax.color.averageColour = function (t) {
    for (
      ...
      (e += i[a]), (r += i[a + 1]), (o += i[a + 2]), n++;
    return (
      (e = ~~(e / n)),
      (r = ~~(r / n)),
      (o = ~~(o / n)),
      relax.color.rgb2hex(e, r, o, 1, !1)
    );
  }),
  (relax.color.averageColours = function (t, e) {
    for (
      var r,
        ...
        n,
        i = new Array(),
        a = Math.round(Math.sqrt(e)),
        s = t.getContext("2d"),
        l = 0,
        c = 0,
        u = 0,
        h = 0,
        d = Math.round(t.width / a),
        p = Math.round(t.height / a),
        g = 0;
      g < e;
      g++
    )
      (o = (r = document.createElement("canvas")).getContext("2d")),
        (n = s.getImageData(u, h, d, p)),
        o.putImageData(n, 10, 70),
        i.push(relax.color.averageColour(r)),
        (u = d * (c = g % a)),
        (h = p * l),
        c == a - 1 && l++;
    return i;
  ...
  (relax.color.shadeColor = function (t, e) {
    ...
    return (
      ...
      (
        16777216 +
        65536 * (Math.round((o - i) * n) + i) +
        256 * (Math.round((o - a) * n) + a) +
        (Math.round((o - s) * n) + s)
      )
        .toString(16)
        .slice(1)
  ...
  (relax.color.blendColors = function (t, e, r) {
    ...
    return (
      ...
      (
        16777216 +
        65536 * (Math.round((l - i) * r) + i) +
        256 * (Math.round((c - a) * r) + a) +
        (Math.round((u - s) * r) + s)
      )
        .toString(16)
        .slice(1)
  ...
  (relax.displayObject.Image = Class.extend({
    ...
    init: function (t) {
      t && t.src && (this.src = t.src),
        t && !0 === t.convertToBase64 && (this._convertToBase64 = !0),
        t && !0 === t.progress && (this._allowProgress = !0);
    },
    load: function (t, e, r) {
      (this.progress = 0),
        (this.loading = !0),
        "string" == typeof t
          ? ((this.src = t), (this._allowProgress = !0 !== r))
          : ((e = t.callback), t.src && (this.src = t.src)),
        this.addCallback(e);
      var o =
        0 < relax.browser.getInternetExplorerVersion() &&
        relax.browser.getInternetExplorerVersion() < 10;
    ...
    onRequestLoaded: function () {
      -(this.progress = 1) === this.src.indexOf(".gif") &&
      ...
      this._allowProgress
        ? ((this.data = new Image()),
          ...
          (this.data.src =
            ...
            this.base64Encode(this.request.responseText)))
        : this.data
        ? this.onImageLoaded()
        : ((this.data = new Image()),
          (this.data.onload = relax.dom.bind(this, this.onImageLoaded)),
    ...
    dealoc: function () {
      this.stop(),
        this.data && ((this.data.onload = void 0), (this.data = null)),
    ...
    base64Encode: function (t) {
      for (
        ...
        isNaN(s)
          ? (n = i = 64)
          : ((n = ((15 & s) << 2) | (l >> 6)), (i = isNaN(l) ? 64 : 63 & l)),
          (r += e.charAt(c) + e.charAt(u) + e.charAt(n) + e.charAt(i));
      }
      return r;
    },
  })),
  ...
  (relax.layout.DeviceOrientChange = function (t) {
    ...
    t(e, window.orientation),
      (window.onorientationchange = function () {
        (e = 90 === Math.abs(window.orientation) ? "Landscape" : "Portrait"),
          t(e, window.orientation);
      });
  }),
  ...
  (relax.draw.imageIntoCanvas = function (t, e) {
    ...
    if (
      ...
      !t ||
        ...
        void 0 === t.image ||
        void 0 === t.imageWidth ||
        void 0 === t.imageHeight ||
        void 0 === t.viewportWidth ||
        void 0 === t.viewportHeight)
    )
    ...
    if (
      ...
      t.imageHeight * r < t.viewportHeight &&
        (r = t.viewportHeight / t.imageHeight),
  ...
  (relax.string.wrapWords = function (t, e, r) {
    for (
      ...
      for (
        ...
        0 < s[h].length && (i[a++] = e + s[h] + r);
      for (i[a++] = o[2], h = 0; h < u; h++)
        0 < c[h].length && (i[a++] = e + c[h] + r);
    }
    return i.join(" ");
  }),
  (relax.string.getHumanReadableSize = function (t) {
    var e = Math.floor(Math.log(t) / Math.log(1024)),
      r = ["b", "kb", "mb", "gb", "tb"];
    return (
      (e = Math.min(r.length - 1, e)),
      1 * Number((t / Math.pow(1024, e)).toFixed(2)) + " " + r[e]
    );
  }),
  (relax = relax || {}).numbers || (relax.numbers = {}),
  (relax.numbers.splitInThousands = function (t, e) {
    return (
      null == e && (e = ","), t.toString().replace(/\B(?=(\d{3})+(?!\d))/g, e)
    );
  }),
  ...
  (relax.tools.DragAndSwipe = Class.extend({
    ...
    init: function (t, e) {
      null == relax.tools.DragAndSwipe.iid &&
        (relax.tools.DragAndSwipe.iid = 0),
    ...
    _onTouchEnd: function () {
      if (
        ...
        var t = this._mouseObj.x > this._startX ? "left" : "right",
          ...
          n = !1;
        "xy" === this._forceDirection
          ? (r || o) && (n = !0)
          : "x" === this._forceDirection && r
          ? (n = !0)
          : "y" === this._forceDirection && o && (n = !0),
          n && this._swipeCallback({ xDirection: t, yDirection: e });
      }
      this._onDragging();
    },
    ...
    _onDragging: function (t, e) {
      this._maxMinBoundries &&
        (this._maxMinBoundries.minSwipeX &&
          ((this._dragXTarget = Math.max(
            this._maxMinBoundries.minSwipeX,
            this._dragXTarget
          )),
          (this._dragX = Math.max(
            this._maxMinBoundries.minSwipeX,
            this._dragX
          ))),
        this._maxMinBoundries.minSwipeY &&
          ((this._dragYTarget = Math.max(
            this._maxMinBoundries.minSwipeY,
            this._dragYTarget
          )),
          (this._dragY = Math.max(
            this._maxMinBoundries.minSwipeY,
            this._dragY
          ))),
        this._maxMinBoundries.maxSwipeX &&
          ((this._dragXTarget = Math.min(
            this._maxMinBoundries.maxSwipeX,
            this._dragXTarget
          )),
          (this._dragX = Math.min(
            this._maxMinBoundries.maxSwipeX,
            this._dragX
          ))),
        this._maxMinBoundries.maxSwipeY &&
          ((this._dragYTarget = Math.min(
            this._maxMinBoundries.maxSwipeY,
            this._dragYTarget
          )),
          (this._dragY = Math.min(
            this._maxMinBoundries.maxSwipeY,
            this._dragY
          )))),
        this._dragCallback &&
    ...
    addEvents: function () {
      this._touchEventsAdded ||
        ...
        $(this._el).bind(
          "touchstart." + this._iid,
          relax.dom.bind(this, this._onTouchStart)
        ),
        $(this._el).bind(
          "touchmove." + this._iid,
          relax.dom.bind(this, this._onTouchMove)
        ),
        $(this._el).bind(
          "touchend." + this._iid,
          relax.dom.bind(this, this._onTouchEnd)
        ));
    },
  ...
  (relax.tools.PinchGestureWrapper = Class.extend({
    ...
    init: function (t, e) {
      (this._el = t),
        ...
        $(this._el).bind(
          "gesturestart.pinch",
          relax.dom.bind(this, this._onGestureStart)
        ),
        $(this._el).bind(
          "gesturechange.pinch",
          relax.dom.bind(this, this._onGestureChange)
        ),
        $(this._el).bind(
          "gestureend.pinch",
          relax.dom.bind(this, this._onGestureEnd)
        );
    },
    dealoc: function () {
      $(this._el).unbind(
        "gesturestart.pinch gesturechange.pinch gestureend.pinch"
      ),
        (this._el = null),
        (this._callback = null);
    },
  ...
  (relax.tools.renderQue = {
    ...
    render: function () {
      if (!this.items || 0 === this.items.length || !this.running)
        return (this.running = !1), void cancelAnimationFrame(this.rAF);
    ...
    add: function (t) {
      if (t && this.items) {
        if (void 0 === t.renderQueCall)
          throw new Error(
            "RenderQue requires objects to have a renderQueCall method for callback."
          );
  ...
  (relax.tools.clone = function (t) {
    ...
    if (t instanceof Array)
      for (e = [], r = 0, o = t.length; r < o; ++r)
        r in t && e.push(clone(t[r]));
  ...
  (relax.EventDispatcher = EventDispatcher =
    (function () {
      function t() {
      ...
      return (
        ...
        (t.prototype.trigger = function (t, e) {
          return (
            null == e && (e = null),
            null !== e
              ? this.eventChannel.trigger(t, e)
              : this.eventChannel.trigger(t)
          );
        }),
  ...
  (relax.Vector2d.prototype = {
    ...
    toString: function (t) {
      ...
      return (
        "[" +
        Math.round(this.x * e) / e +
        ", " +
        Math.round(this.y * e) / e +
        "]"
      );
    },
    clone: function () {
    ...
    angle: function (t) {
      return (
        Math.atan2(this.y, this.x) * (t ? 1 : relax.Vector2dConst.TO_DEGREES)
      );
    },
    rotate: function (t, e) {
      ...
      return (
        relax.Vector2dConst.temp.copyFrom(this),
        (this.x =
          relax.Vector2dConst.temp.x * r - relax.Vector2dConst.temp.y * o),
        (this.y =
          relax.Vector2dConst.temp.x * o + relax.Vector2dConst.temp.y * r),
        this
      );
    },
    equals: function (t) {
    ...
    isCloseTo: function (t, e) {
      return (
        !!this.equals(t) ||
        (relax.Vector2dConst.temp.copyFrom(this),
        relax.Vector2dConst.temp.minusEq(t),
        relax.Vector2dConst.temp.magnitudeSquared() < e * e)
      );
    },
    rotateAroundPoint: function (t, e, r) {
      relax.Vector2dConst.temp.copyFrom(this),
        relax.Vector2dConst.temp.minusEq(t),
        relax.Vector2dConst.temp.rotate(e, r),
        relax.Vector2dConst.temp.plusEq(t),
        this.copyFrom(relax.Vector2dConst.temp);
    },
  ...
  relax.BasicRelaxService = BasicRelaxService = (function (t) {
    ...
    return (
      ...
      (e.prototype.initialize = function (t) {
        return (this.url =
          "//services.rwatgg.com/" + t.client + "/" + t.service + "/");
      }),
      (e.prototype.fetch = function (t) {
        return (
          null == t && (t = new Object()),
          t.success ||
            ((t.success = relax.dom.bind(this, this.onSuccess)),
      ...
      (e.prototype.onError = function (t, e) {
        ...
        if (
          (console &&
            console.log(
              "%c RWATGG > UserLocation Error: status:",
          ...
          return console.log(
            "%c RWATGG > UserLocation Error: statusText:",
            "background: red; color: white;",
            e.statusText
          );
      }),
      ...
      (n.prototype.fetch = function (t) {
        ...
        if (
          ...
          relax.caniuse.localstorage() &&
            ...
            0 <
              (o =
                (r = JSON.parse(sessionStorage.getItem("rwatgg_location")))
          ...
          return (
            t.success ||
              ((t.success = relax.dom.bind(this, this.onSuccess)),
              (t.error = relax.dom.bind(this, this.onError))),
            n.__super__.fetch.call(this, t)
          );
      }),
      (n.prototype.onSuccess = function (t, e) {
        if (
          (relax.caniuse.localstorage() &&
            (this.set("timestamp", new Date().getTime(), { silent: !0 }),
  ...
  relax.SocialFeed = SocialFeed = (function (t) {
    ...
    return (
      ...
      (e.prototype.initialize = function (t) {
        ...
        return (
          (e = t.useProxy ? "/handlers/proxy.ashx?url=" : "//"),
          (this.url =
            e + "services.rwatgg.com/" + t.client + "/" + t.feed + "/")
        );
      }),
      (e.prototype.fetch = function (t) {
        return (
      ...
      (e.prototype.onSuccess = function (t, e) {
        if (console)
          return console.log(
            "%c RWATGG > " + this.get("feed") + " Success",
            "background: green; color: white;"
          );
      }),
      (e.prototype.onError = function (t, e) {
        ...
        if (
          (console &&
            console.log(
              "%c RWATGG > " + this.get("feed") + " Error: status:",
              "background: red; color: white;",
              e.status
            ),
          console)
          ...
          return console.log(
            "%c RWATGG > " + this.get("feed") + " Error: statusText:",
            "background: red; color: white;",
            e.statusText
          );
      }),
...
(extend = function (t, e) {
  ...
  (relax.Counter = (function (t) {
    function e(t) {
      e.__super__.constructor.call(this),
        ...
        (this._currentStep = this._step =
          isNaN(t.step) ? relax.Counter.DEFAULT_STEP : t.step),
    ...
    return (
      ...
      (e.prototype.resume = function () {
        return (
          this.trigger(relax.Counter.ON_STEP_START_EVENT, this), this.start()
        );
      }),
      ...
      (e.prototype.pause = function () {
        return (
          (this._isRunning = !1),
          clearTimeout(this._timeout),
          this.trigger(relax.Counter.ON_STEP_STOP_EVENT, this)
        );
      }),
      ...
      (e.prototype.onStep = function () {
        return (
          (this._currentStep += this._step * this._direction),
          this.validateStep()
        );
      }),
        ...
        if (
          ...
          this._stopOnEnd && this._currentStep >= this._maxSteps - 1
            ...
            : !this._loop &&
              -1 !== this._maxSteps &&
              (this._currentStep <= 0 ||
                this._currentStep >= this._maxSteps - 1) &&
              (this._direction *= -1),
  ...
  (relax.SocialSharer = SocialSharer =
    (function () {
      function t() {}
      return (
            ...
            window.FB
              ...
              : ((o = void 0),
                ...
                document.getElementById(r)
                  ? void 0
                  : (((o = document.createElement("script")).id = r),
                    (o.async = !0),
        ...
        (t.prototype.shareFacebook = function (e) {
          ...
          (o = e.name),
            ...
            (t = e.caption || ""),
            (n = e.picture || ""),
            (i = e.url || "http://" + window.location.host);
          try {
            return (
              (a = {
              ...
              FB.ui(a, function (t) {
                if (t && t.post_id) {
                  if ((e.callback && e.callback(t), console && console.log))
        ...
        (t.prototype.shareEmail = function (t) {
          return (document.location.href =
            "mailto:?subject=" + t.subject + "&body=" + t.body);
        }),
  ...
  (hasProp = {}.hasOwnProperty),
  (window.relax.ImageLoader = ImageLoader =
    (function (t) {
      function A(t) {
        var e,
          r,
        ...
        if (
          ...
          !0 === t.allowProgress && (this._allowProgress = t.allowProgress),
          !t.sources)
        )
          throw new Error("ImageLoader: sources needs to be defined.");
        for (
          t.loadOrder && (this._loadOrder = t.loadOrder),
            this._loadCue = [],
            this._data = [],
            i = 0,
            l = (y = t.sources).length;
          i < l;
          i++
        )
          (E = y[i]),
            this._data.push(
              new relax.displayObject.Image({
                src: E,
                progress: !0 === t.allowProgress,
              })
            ),
            (this._data[E] = this._data.length - 1);
        if (this._loadOrder === relax.ImageLoader.ORDER_DIVIDE_AND_CONQUER) {
          for (p = [], a = 0, c = (v = t.sources).length; a < c; a++)
            v[a], p.push(p.length);
          for (
            m = 0,
              (_ = []).push(p.splice(0, 1)[0]),
              _.push(p.splice(p.length - 1, 1)[0]);
            0 < p.length;
            ...
            for (g = 0, u = p.length; g < u; g++) {
              for (
                ...
                ((e +=
                  r % 2 == 0
                    ? Math.round((s - r) * (p.length / s))
                    : Math.round(r * (p.length / s))),
                (T = null),
                0 < p.length && (T = p.splice(e, 1)[0]),
                T && _.push(T),
                0 !== p.length);
                r = f += 1
              );
          ...
          for (x = 0, h = _.length; x < h; x++)
            (n = _[x]), this._loadCue.push(this._data[n]);
        } else
          for (w = 0, d = (S = this._data).length; w < d; w++)
            (o = S[w]), this._loadCue.push(o);
      ...
      return (
        ...
        (A.prototype.pause = function (t) {
          ...
          if ((null == t && (t = !1), (this._paused = !0), t)) {
            for (i = [], r = 0, o = (n = this._loadCue).length; r < o; r++)
              (e = n[r]).loaded ? i.push(void 0) : i.push(e.stop());
            return i;
          }
        }),
        (A.prototype.resume = function () {
          if (((this._paused = !1), !this.loaded))
            return this.load(this._loadAllAtSameTime);
        }),
        (A.prototype.load = function (t) {
          ...
          if ((null == t && (t = !1), !this._paused)) {
            if (((this._loadAllAtSameTime = t), !this.loaded))
              if (
                ((this._leftToBeLoaded = this._loadCue.length),
                this._loadAllAtSameTime)
              ) {
                if (this._loadAllAtSameTime)
                  for (r = 0, o = (i = this._loadCue).length; r < o; r++)
                    (e = i[r]).loaded ||
                      e.load({
                        callback: relax.dom.bind(this, this.onImageLoaded),
                      });
              } else
                null != (n = this.getNextImageToLoad()) &&
                  n.load({
                    callback: relax.dom.bind(this, this.onImageLoaded),
                  });
            return this._allowProgress && !relax.tools.renderQue.has(this)
        ...
        (A.prototype.renderQueCall = function () {
          var t, e, r, o;
          for (t = r = 0, e = (o = this._data).length; t < e; t++)
            r += o[t].progress / this._data.length;
          if (r !== this._loadProgress)
            return (
              (this._loadProgress = r),
              this.trigger(window.relax.ImageLoader.LOADING, this._loadProgress)
            );
        }),
        (A.prototype.getNextImageToLoad = function () {
          var t, e, r, o;
          for (e = 0, r = (o = this._loadCue).length; e < r; e++)
            if (!(t = o[e]).loading) return t;
        }),
        (A.prototype.onImageLoaded = function (t) {
          if (
            (this.trigger(relax.ImageLoader.IMAGE_LOADED, t),
            0 == --this._leftToBeLoaded)
          )
            return (
              (this.loaded = !0),
              relax.tools.renderQue.has(this) &&
                relax.tools.renderQue.remove(this),
              this.trigger(relax.ImageLoader.LOADED, this)
            );
        }),
        (A.prototype.getImage = function (t, e) {
          ...
          if (
            (null == e && (e = !1),
            this._loadOrder === relax.ImageLoader.ORDER_DIVIDE_AND_CONQUER &&
              (e = !0),
            (n = null),
            isNaN(t))
          ) {
          ...
          } else if (!(n = this._data[t]).loaded && !e)
            throw new Error("Trying to get image that is not loaded");
          if (e && !n.loaded)
            for (
              r = this._data.indexOf(n) + 1, o = this._data.indexOf(n) - 1;
              !n.loaded && (0 <= o || r < this._data.length);

            )
              r < this._data.length && this._data[r].loaded
                ? (n = this._data[r])
                : 0 <= o && this._data[o].loaded
                ? (n = this._data[o])
                : ((r += 1), (o -= 1));
          return n;
        }),
    ...
    (function (t) {
      function a(t) {
          ...
          for (
            this._mediaQueries = t.mediaqueries,
              this._mediaQueries.sort(function (t, e) {
                return t.horizontalBreakPoint < e.horizontalBreakPoint
                  ? -1
                  : t.horizontalBreakPoint > e.horizontalBreakPoint
                  ? 1
                  : 0;
              }),
              e = 0,
        ...
        (this.scrollContext = t && t.scrollContext ? t.scrollContext : window),
          ...
          o.addEventListener(
            "orientationchange",
            relax.dom.bind(this, this.resize),
            !1
          ),
          this.scrollContext.addEventListener(
            "scroll",
            relax.dom.bind(this, this.scroll),
            !!relax.caniuse.passiveEvents && { passive: !0 }
          ),
          this.updateScrollY(),
          this.resize(),
          relax.tools.renderQue.add(this);
      ...
      return (
        ...
        (a.prototype.renderQueCall = function () {
          if (this.scrolling)
            return (this.scrolling = !1), this.updateScrollY();
        }),
        ...
        (a.prototype.handleScroll = function () {
          return (
            (this.scrollDirection =
              this._tempScrollY < this.scrollTop
                ? -1
                : this._tempScrollY > this.scrollTop
                ? 1
                : 0),
        ...
        (a.prototype.resize = function (t) {
          if (
            ...
            (this.orientationMode =
              this.w / this.h <= 0.87
                ? relax.StageModel.ORIENTATION_PORTRAIT
                : relax.StageModel.ORIENTATION_LANDSCAPE),
        ...
        (a.prototype.checkMediaQueries = function (t) {
          ...
          for (
            ...
            if (
              (o = n[e]).horizontalBreakPoint &&
              o.horizontalBreakPoint > this.w
            ) {
              (this.currentMQ !== o.eventName || t) &&
                ((this.currentMQ = o.eventName),
...
var VirtualScroll = (function (e) {
  ...
  var Y = function (e) {
    ...
    L = function (e) {
      (X.deltaX = e.wheelDeltaX || -1 * e.deltaX),
        (X.deltaY = e.wheelDeltaY || -1 * e.deltaY),
        E && 1 == e.deltaMode && ((X.deltaX *= s), (X.deltaY *= s)),
        (X.deltaX *= c),
        (X.deltaY *= c),
        Y(e);
    },
    y = function (e) {
      (X.deltaX = e.wheelDeltaX ? e.wheelDeltaX : 0),
        (X.deltaY = e.wheelDeltaY ? e.wheelDeltaY : e.wheelDelta),
        Y(e);
    },
    M = function (e) {
    ...
    p = function (e) {
      var t = e.targetTouches ? e.targetTouches[0] : e;
      (X.deltaX = (t.pageX - o) * d),
        (X.deltaY = (t.pageY - a) * d),
        (o = t.pageX),
        (a = t.pageY),
        Y(e);
    },
    ...
    T = function () {
      v && e.addEventListener("wheel", L),
        ...
        f &&
          m &&
          ((t = e.body.style.msTouchAction),
          (e.body.style.msTouchAction = "none"),
          e.addEventListener("MSPointerDown", M, !0),
          e.addEventListener("MSPointerMove", p, !0)),
    ...
    k = function () {
      v && e.removeEventListener("wheel", L),
        ...
        f &&
          m &&
          ((e.body.style.msTouchAction = t),
          e.removeEventListener("MSPointerDown", M, !0),
          e.removeEventListener("MSPointerMove", p, !0)),
    ...
    function (w) {
      var e,
        ...
        a = function (t, n, e, i, o) {
          var s = u(
            "easing." + t,
            { easeOut: new n(), easeIn: new e(), easeInOut: new i() },
            !0
          );
          return c(s, t), s;
        },
    ...
    function (n, L) {
      ...
      var S,
        ...
        G =
          ...
          (m =
            -1 !== q.indexOf("Safari") &&
            -1 === q.indexOf("Chrome") &&
            (-1 === e || 3 < parseFloat(q.substr(e + 8, 2)))),
          ...
          return G || "opacity" !== e
            ? (!i && t.style[e]
                ...
                ? (n =
                    ...
                    r.getPropertyValue(e.replace(o, "-$1").toLowerCase()))
        ...
        rt = (s.convertToPixels = function (t, e, r, i, s) {
          ...
          if ((h && (r = -r), c && (r *= 100), "lineHeight" !== e || i))
            if ("%" === i && -1 !== e.indexOf("border"))
              n = (r / 100) * (l ? t.clientWidth : t.clientHeight);
            else {
              if (
                ((p.cssText =
              ...
              f.appendChild(Z),
                ...
                l &&
                  "%" === i &&
                  !1 !== I.cacheWidths &&
                  (((a = f._gsCache = f._gsCache || {}).time = o),
                  (a.width = (n / r) * 100)),
        ...
        it = (s.calculateOffset = function (t, e, r) {
          ...
          var i = "left" === e ? "Left" : "Top",
            s = et(t, "margin" + i, r);
          return (
            t["offset" + i] - (rt(t, e, parseFloat(s), s.replace(R, "")) || 0)
          );
        }),
        st = function (t, e) {
          var r,
          ...
          if ((e = e || tt(t, null)))
            if ((r = e.length))
              for (; -1 < --r; )
                (-1 !== (s = e[r]).indexOf("-transform") && zt !== s) ||
                  (n[s.replace(l, h)] = e.getPropertyValue(s));
            else
              for (r in e)
                (-1 !== r.indexOf("Transform") && Yt !== r) || (n[r] = e[r]);
        ...
        lt = function (t, e, r) {
          ...
          var i = parseFloat("width" === e ? t.offsetWidth : t.offsetHeight),
            s = at[e],
            n = s.length;
          for (r = r || tt(t, null); -1 < --n; )
            (i -= parseFloat(et(t, "padding" + s[n], r, !0)) || 0),
              (i -= parseFloat(et(t, "border" + s[n] + "Width", r, !0)) || 0);
          return i;
        },
        ft = function (t, e) {
      ...
      var mt = function (t, e, n, a) {
          ...
          return u
            ? (o = e
                ? function (t) {
                    ...
                    if (
                      ((e = (t.match(yt) || [l])[0]),
                      (i = (r = t.split(e).join("").match(v) || []).length),
                      u > i--)
                    )
                      for (; ++i < u; ) r[i] = n ? r[((i - 1) / 2) | 0] : f[i];
                    return (
                      p +
                      r.join(c) +
                      c +
                ...
                : function (t) {
                    ...
                    if (((i = (e = t.match(v) || []).length), u > i--))
                      for (; ++i < u; ) e[i] = n ? e[((i - 1) / 2) | 0] : f[i];
                    return p + e.join(c) + h;
                  })
            : function (t) {
                return t;
        ...
        vt =
          ((s._setPluginRatio = function (t) {
            ...
            for (
              var e, r, i, s, n, a = this.data, o = a.proxy, l = a.firstMPT;
              l;
        ...
        wt = (I.parseComplex = function (t, e, r, i, s, n, a, o, l, f) {
          (r = r || n || ""),
            "function" == typeof i && (i = i(k, X)),
            (a = new bt(t, e, 0, 0, a, f ? 2 : 1, null, !1, o, r, i)),
            (i += ""),
            s &&
              yt.test(i + r) &&
              ((i = [r, i]), I.colorStringFilter(i), (r = i[0]), (i = i[1]));
          var p,
            h,
            c,
            u,
          ...
          for (
            (-1 === i.indexOf(",") && -1 === r.indexOf(",")) ||
              ((P =
                -1 !== (i + r).indexOf("rgb") || -1 !== (i + r).indexOf("hsl")
                  ? ((w = w.join(" ").replace(z, ", ").split(" ")),
                    P.join(" ").replace(z, ", ").split(" "))
                  : ((w = w.join(" ").split(",").join(", ").split(" ")),
            ...
            if (((u = w[p]), (x = P[p]), (y = parseFloat(u)) || 0 === y))
              a.appendXtra(
                "",
                y,
                pt(x, y),
              ...
              (b = ")" + ((b = x.indexOf(")") + 1) ? x.substr(b) : "")),
                ...
                (m = 6 < u.length + x.length) && !G && 0 === x[3]
                  ? ((a["xs" + a.l] += a.l ? " transparent" : "transparent"),
                    (a.e = a.e.split(P[p]).join("transparent")))
                  : (G || (m = !1),
                    O
                      ? a
                          .appendXtra(
          ...
          if (-1 !== i.indexOf("=") && a.data) {
            for (b = a.xs0 + a.data.s, p = 1; p < a.l; p++)
              b += a["xs" + p] + a.data["xn" + p];
            a.e = b + a["xs" + p];
          }
          return a.l || ((a.type = -1), (a.xs0 = a.e)), a.xfirst || a;
        }),
        Pt = 9;
      for ((t = bt.prototype).l = t.pr = 0; 0 < --Pt; )
        (t["xn" + Pt] = 0), (t["xs" + Pt] = "");
      (t.xs0 = ""),
        (t._next =
          t._prev =
          ...
          if (!g[t]) {
            ...
            Mt(t, {
              parser: function (t, e, r, i, s, n, a) {
                ...
                return o
                  ? (o._cssRegister(), g[r].parse(t, e, r, i, s, n, a))
                  : (U("Error: " + l + " js file not loaded."), s);
              },
            });
          }
        });
      ((t = Tt.prototype).parseComplex = function (t, e, r, i, s, n) {
        ...
        (t.parse = function (t, e, r, i, s, n, a) {
          return this.parseComplex(
            t.style,
            this.format(et(t, this.p, M, !1, this.dflt)),
            this.format(e),
            s,
            n
          );
      ...
      var Xt,
        ...
        Lt = function (t, e, r) {
          var i,
            ...
            n = /([a-z])([A-Z])/g;
          for (i in r)
            s.setAttributeNS(null, i.replace(n, "$1-$2").toLowerCase(), r[i]);
        ...
        Wt = function (t, e, r, i, s, n) {
          ...
          v && ((m = v.xOrigin), (_ = v.yOrigin)),
            ...
            i &&
              ...
              (g = b[5]),
              (y = h * x - c * u) &&
                ((o = f * (x / y) + p * (-u / y) + (u * g - x * d) / y),
                (l = f * (-c / y) + p * (h / y) - (h * g - c * d) / y),
                (f = r.xOrigin = a[0] = o),
                (p = r.yOrigin = a[1] = l))),
            v &&
              (n && ((r.xOffset = v.xOffset), (r.yOffset = v.yOffset), (v = r)),
              s || (!1 !== s && !1 !== I.defaultSmoothOrigin)
                ? ((o = f - m),
                  (l = p - _),
                  (v.xOffset += o * b[0] + l * b[2] - o),
                  (v.yOffset += o * b[1] + l * b[3] - l))
        ...
        qt = function (t, e) {
          ...
          if (
            ...
            return Ht;
          for (s = (i || "").match(A) || [], Pt = s.length; -1 < --Pt; )
            (n = Number(s[Pt])),
              (s[Pt] = (a = n - (n |= 0))
        ...
        Gt = (s.getTransform = function (t, e, r, i) {
          ...
          var s,
            ...
            c =
              (Bt &&
                (parseFloat(et(t, Nt, e, !1, "0 0 0").split(" ")[2]) ||
                  p.zOrigin)) ||
              0,
          ...
          if (
            ...
            if (16 === s.length) {
              var x,
                ...
                Y = Math.atan2(T, k);
              p.zOrigin &&
                ((A = S * (R = -p.zOrigin) - s[12]),
                (F = X * R - s[13]),
                (R = k * R + p.zOrigin - s[14])),
                (p.rotationX = Y * E),
                Y &&
                ...
                (p.rotationY = Y * E),
                Y &&
                  ((d = v * (y = Math.cos(-Y)) - X * (m = Math.sin(-Y))),
                  (g = b * y - k * m),
                  (X = v * m + X * y),
                  (k = b * m + k * y),
                  (C = O * m + C * y),
                ...
                (p.rotation = Y * E),
                Y &&
                  ((x = _ * (y = Math.cos(Y)) + v * (m = Math.sin(Y))),
                  (d = w * y + P * m),
                  (g = S * y + X * m),
                  (v = v * y - _ * m),
                  (P = P * y - w * m),
                ...
                (Y = Math.atan2(w, P)),
                (p.scaleX =
                  ((1e5 * Math.sqrt(_ * _ + v * v + b * b) + 0.5) | 0) / 1e5),
                (p.scaleY = ((1e5 * Math.sqrt(P * P + T * T) + 0.5) | 0) / 1e5),
                (p.scaleZ =
                  ((1e5 * Math.sqrt(S * S + X * X + k * k) + 0.5) | 0) / 1e5),
                (_ /= p.scaleX),
                (w /= p.scaleY),
                (v /= p.scaleX),
                (P /= p.scaleY),
                2e-5 < Math.abs(Y)
                  ? ((p.skewX = Y * E),
                    (w = 0),
                    "simple" !== p.skewType && (p.scaleY *= 1 / Math.cos(Y)))
                  : (p.skewX = 0),
                ...
                (p.z = R),
                p.svg &&
                  ((p.x -= p.xOrigin - (p.xOrigin * _ - p.yOrigin * w)),
                  (p.y -= p.yOrigin - (p.yOrigin * v - p.xOrigin * P)));
            } else if (
              !Bt ||
              i ||
              !s.length ||
              ...
              (p.x = s[4] || 0),
                ...
                Bt &&
                  ...
                  (p.scaleZ = 1)),
                p.svg &&
                  ((p.x -= p.xOrigin - (p.xOrigin * N + p.yOrigin * j)),
                  (p.y -= p.yOrigin - (p.xOrigin * B + p.yOrigin * V)));
            }
        ...
        $t = function (t) {
          ...
          if (c) {
            ...
            if (
              (null != i.ox &&
                ((_ +=
                  (u = (i.oxp ? d * i.ox * 0.01 : i.ox) - d / 2) -
                  (u * o + (x = (i.oyp ? g * i.oy * 0.01 : i.oy) - g / 2) * l)),
                (v += x - (u * f + x * p))),
              (m += y
                ? ", Dx=" +
                  ((u = d / 2) - (u * o + (x = g / 2) * l) + _) +
              ...
              for (
                u = i.ieOffsetX || 0,
                  ...
                  i.ieOffsetX = Math.round(
                    (d - ((o < 0 ? -o : o) * d + (l < 0 ? -l : l) * g)) / 2 + _
                  ),
                  i.ieOffsetY = Math.round(
                    (g - ((p < 0 ? -p : p) * g + (f < 0 ? -f : f) * d)) / 2 + v
                  ),
                  Pt = 0;
                Pt < 4;
                Pt++
                ...
                (w =
                  (r =
                    -1 !== (b = c[(O = ot[Pt])]).indexOf("px")
                      ? parseFloat(b)
                      : rt(this.t, O, parseFloat(b), b.replace(R, "")) || 0) !==
                  i[O]
                    ? Pt < 2
                      ? -i.ieOffsetX
                      : -i.ieOffsetY
              ...
              if (
                ...
                M || V || z
                  ? ((M *= W),
                    ...
                    z &&
                      ((R +=
                        P.xOrigin -
                        (P.xOrigin * r + P.yOrigin * i) +
                        P.xOffset),
                      (C +=
                        P.yOrigin -
                        (P.xOrigin * n + P.yOrigin * a) +
                        P.yOffset),
                      Xt &&
                        (P.xPercent || P.yPercent) &&
                        ((d = this.t.getBBox()),
                        (R += 0.01 * P.xPercent * d.width),
                        (C += 0.01 * P.yPercent * d.height)),
                      R < (d = 1e-6) && -d < R && (R = 0),
                      C < d && -d < C && (C = 0)),
                    (_ =
                      ((r * w) | 0) / w +
                ...
                (p = 1),
                  ...
                  (M = X * W) &&
                    ...
                    (n *= g)),
                  (M = S * W) &&
                    ((e = i * (g = Math.cos(M)) + s * (y = Math.sin(M))),
                    (m = a * g + o * y),
                    (f = p * y),
                    (c = u * y),
                    (s = i * -y + s * g),
      ...
      ((t = jt.prototype).x =
        ...
        Mt(
          "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
          {
            parser: function (t, e, r, i, s, n, a) {
              ...
              var o,
                l =
                  (i._lastParsedTransform = a).scale &&
                  "function" == typeof a.scale
                    ? a.scale
                    : 0;
              "function" == typeof a[r] && ((o = a[r]), (a[r] = e)),
                l && (a.scale = l(k, t));
              var f,
                p,
                h,
                ...
                T =
                  ...
                  ("function" == typeof b.transform
                    ...
                    : b.transform);
              if (
                ((P.skewType = b.skewType || P.skewType || I.defaultSkewType),
                (i._transform = P),
                T && "string" == typeof T && Yt)
              )
                ((p = Z.style)[Yt] = T),
                  (p.display = "block"),
                  (p.position = "absolute"),
                  ...
                  P.svg &&
                    ...
                    (b.transformOrigin || b.svgOrigin) &&
                      ...
                      (x = T.xOrigin),
                      (d = T.yOrigin),
                      (f.x -= T.xOffset - P.xOffset),
                      (f.y -= T.yOffset - P.yOffset)),
                    (x || d) &&
                      ((g = qt(Z, !0)),
                      (f.x -= x - (x * g[0] + d * g[2])),
                      (f.y -= d - (x * g[1] + d * g[3])))),
                  ...
                  null != b.xPercent &&
                    (f.xPercent = ht(b.xPercent, P.xPercent)),
                  null != b.yPercent &&
                    (f.yPercent = ht(b.yPercent, P.yPercent));
                ...
                "string" == typeof b.x &&
                  -1 !== b.x.indexOf("%") &&
                  ((f.x = 0), (f.xPercent = ht(b.x, P.xPercent))),
                  "string" == typeof b.y &&
                    -1 !== b.y.indexOf("%") &&
                    ((f.y = 0), (f.yPercent = ht(b.y, P.yPercent))),
                  (f.rotation = ct(
                    "rotation" in b
                      ? b.rotation
                      : "shortRotation" in b
              ...
              for (
                Bt && null != b.force3D && ((P.force3D = b.force3D), (c = !0)),
                  (h =
                    P.force3D ||
                    P.z ||
                    P.rotationX ||
              ...
              return (
                ...
                P.svg &&
                  ...
                  (x === P.xOffset && d === P.yOffset) ||
                    ((s = Ot(P, "xOffset", m ? x : P.xOffset, P.xOffset, s, w)),
                    (s = Ot(P, "yOffset", m ? d : P.yOffset, P.yOffset, s, w))),
                  (T = "0px 0px")),
                (T || (Bt && h && P.zOrigin)) &&
                  (Yt
                    ? ((c = !0),
                      ...
                      (s.xs0 = s.e =
                        Bt
                          ? ((p = P.zOrigin),
                            (T = T.split(" ")),
                            (P.zOrigin =
                              (2 < T.length && (0 === p || "0px" !== T[2])
                                ? parseFloat(T[2])
                                : p) || 0),
                            (s.xs0 = s.e =
                              T[0] + " " + (T[1] || "50%") + " 0px"),
                            ((s = new bt(P, "zOrigin", 0, 0, s, -1, s.n)).b =
                              p),
                            P.zOrigin)
                          : T))
                    : ft(T + "", P)),
                c &&
                  (i._transformType =
                    (P.svg && Xt) || (!h && 3 !== this._transformType) ? 2 : 3),
                o && (a[r] = o),
                l && (a.scale = l),
                s
              );
          ...
          parser: function (t, e, r, i, s, n) {
            ...
            for (
              ...
              this.p.indexOf("border") && (O[o] = K(O[o])),
                -1 !== (p = f = et(t, O[o], M, !1, "0px")).indexOf(" ") &&
                  ((p = (f = p.split(" "))[0]), (f = f[1])),
                (h = l = a[o]),
                (c = parseFloat(p)),
                (y = p.substr((c + "").length)),
                "" ===
                  (g = (m = "=" === h.charAt(1))
                    ? ((u = parseInt(h.charAt(0) + "1", 10)),
                      (h = h.substr(2)),
                      (u *= parseFloat(h)),
                      h.substr((u + "").length - (u < 0 ? 1 : 0)) || "")
                    : ((u = parseFloat(h)), h.substr((u + "").length))) &&
                  (g = P[r] || y),
                g !== y &&
                  ...
                  (f =
                    "%" === g
                      ? ((p = (_ / x) * 100 + "%"), (v / d) * 100 + "%")
                      : "em" === g
                      ? ((p = _ / (b = rt(t, "borderLeft", 1, "em")) + "em"),
                        v / b + "em")
                      : ((p = _ + "px"), v + "px")),
                  m &&
                    ((h = parseFloat(p) + u + g), (l = parseFloat(f) + u + g))),
          ...
          "borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius",
          {
            ...
            parser: function (t, e, r, i, s, n) {
              return wt(
                t.style,
                r,
                this.format(et(t, r, M, !1, "0px 0px")),
                this.format(e),
                !1,
                "0px",
                s
          ...
          parser: function (t, e, r, i, s, n) {
            var a,
              ...
              x = this.format(
                (u
                  ? T
                    ? u.getPropertyValue(c + "-x") +
                      " " +
                      u.getPropertyValue(c + "-y")
                    : u.getPropertyValue(c)
              ...
              d = this.format(e);
            if (
              (-1 !== x.indexOf("%")) != (-1 !== d.indexOf("%")) &&
              d.split(",").length < 2 &&
              (h = et(t, "backgroundImage").replace(w, "")) &&
              "none" !== h
            ) {
              for (
                a = x.split(" "),
            ...
            return (
              (e =
                T < 9
                  ...
                  : ((a = this.format(et(t, this.p, M, !1, this.dflt))),
                    this.format(e))),
        ...
        Mt("border", {
          ...
          parser: function (t, e, r, i, s, n) {
            ...
            return (
              "px" !== l &&
                (a = parseFloat(a) / rt(t, "borderTopWidth", 1, l) + l),
              this.parseComplex(
                t.style,
                this.format(
                  a +
                    " " +
                    et(t, "borderTopStyle", M, !1, "solid") +
                    " " +
                    et(t, "borderTopColor", M, !1, "#000")
                ),
                o.join(" "),
                s,
                n
      ...
      var Qt = function (t) {
        ...
        100 === s &&
          (e =
            ...
            -1 === i.indexOf("radient(") &&
            -1 === i.indexOf("oader(")
              ? (r.removeAttribute("filter"), !et(this.data, "filter"))
              : ((r.filter = i.replace(a, "")), !0)),
          e ||
            (this.xn1 && (r.filter = i = i || "alpha(opacity=" + s + ")"),
            -1 === i.indexOf("pacity")
              ? (0 === s && this.xn1) ||
                (r.filter = i + " alpha(opacity=" + s + ")")
              : (r.filter = i.replace(C, "opacity=" + s)));
      };
      Mt("opacity,alpha,autoAlpha", {
        ...
        parser: function (t, e, r, i, s, n) {
          ...
          return (
            ...
            l &&
              1 === a &&
              "hidden" === et(t, "visibility", M) &&
              0 !== e &&
              (a = 0),
            G
              ? (s = new bt(o, "opacity", a, e - a, s))
              : (((s = new bt(o, "opacity", 100 * a, 100 * (e - a), s)).xn1 = l
                  ? 1
                  : 0),
                (o.zoom = 1),
                (s.type = 2),
        ...
        Kt = function (t) {
          if (((this.t._gsClassPT = this), 1 === t || 0 === t)) {
            ...
            for (var e = this.data, r = this.t.style; e; )
              e.v ? (r[e.p] = e.v) : Jt(r, e.p), (e = e._next);
      ...
      Mt("className", {
        parser: function (t, e, r, i, s, n, a) {
          var o,
            ...
            u = t.style.cssText;
          if (
            (((s = i._classNamePT = new bt(t, r, 0, 0, s, 2)).setRatio = Kt),
            (s.pr = -11),
            (x = !0),
            (s.b = c),
            (l = st(t, M)),
      ...
      for (
        Mt("clearProps", {
          parser: function (t, e, r, i, s) {
            return (
              ((s = new bt(t, r, 0, 0, s, 2)).setRatio = te),
              (s.e = e),
              (s.pr = -10),
              (s.data = i._tween),
              (x = !0),
      ...
      ((t = I.prototype)._firstPT =
        ...
        (t._onInitTween = function (t, e, r, i) {
          ...
          if (
            (y &&
              "" === u.zIndex &&
              (("auto" !== (s = et(t, "zIndex", M)) && "" !== s) ||
                this._addLazySet(u, "zIndex", 0)),
            "string" == typeof e &&
              ((o = u.cssText),
              (s = st(t, M)),
              (u.cssText = o + ";" + e),
              (s = nt(t, s, st(t)).difs),
              !G && b.test(e) && (s.opacity = parseFloat(RegExp.$1)),
              (e = s),
              (u.cssText = o)),
            e.className
              ? (this._firstPT = n =
            ...
            (h = new bt(t, "transform", 0, 0, null, 2)),
              ...
              (h.setRatio = Yt ? Ut : $t),
              (h.data = this._transform || Gt(t, M, !0)),
              (h.tween = r),
              (h.pr = -1),
              d.pop();
          }
        ...
        (t.parse = function (t, e, r, i) {
          var s,
            ...
            x = t.style;
          for (s in e) {
            if (("function" == typeof (f = e[s]) && (f = f(k, X)), (n = g[s])))
              r = n.parse(t, f, s, this, r, i, e);
            else {
              if ("--" === s.substr(0, 2)) {
              ...
              (l = et(t, s, M) + ""),
                ...
                (c && O.test(f))
                  ? (c ||
                      (f =
                        (3 < (f = dt(f)).length ? "rgba(" : "rgb(") +
                        f.join(",") +
                        ")"),
                    (r = wt(x, s, l, f, !0, "transparent", r, 0, i)))
                  : c && N.test(f)
                  ...
                  : ((p =
                    ...
                    "" ===
                      (h = (u = c && "=" === f.charAt(1))
                        ? ((o = parseInt(f.charAt(0) + "1", 10)),
                          (f = f.substr(2)),
                          (o *= parseFloat(f)),
                          f.replace(R, ""))
                        : ((o = parseFloat(f)), c ? f.replace(R, "") : "")) &&
                      (h = s in P ? P[s] : p),
              ...
              if (2 !== s.type)
                if (s.r && -1 !== s.type)
                  if (((e = Math.round(s.s + s.c)), s.type)) {
                    if (1 === s.type) {
                      for (i = s.l, r = s.xs0 + e + s.xs1, i = 1; i < s.l; i++)
                        r += s["xn" + i] + s["xs" + (i + 1)];
                      s.t[s.p] = r;
                    }
                  } else s.t[s.p] = e + s.xs0;
        ...
        (t._enableTransforms = function (t) {
          (this._transform = this._transform || Gt(this._target, M, !0)),
            (this._transformType =
          ...
          return (
            t &&
              ...
              t._prev
                ...
                : this._firstPT === t && ((this._firstPT = t._next), (i = !0)),
              r
                ? (r._next = t)
      ...
      var re = function (t, e, r) {
        ...
        if (t.slice) for (s = t.length; -1 < --s; ) re(t[s], e, r);
          ...
          for (s = (i = t.childNodes).length; -1 < --s; )
            (a = (n = i[s]).type),
              n.style && (e.push(st(n)), r && r.push(n)),
              (1 !== a && 9 !== a && 11 !== a) ||
                !n.childNodes.length ||
                re(n, e, r);
      };
  ...
  var h = (_gsScope.document || {}).documentElement,
    ...
    n = function (t, e) {
      var s = "x" === e ? "Width" : "Height",
        ...
        l = document.body;
      return t === r || t === h || t === l
        ? Math.max(h[i], l[i]) - (r["inner" + s] || h[o] || l[o])
        : t[i] - t["offset" + s];
    },
    u = function (t, e) {
    ...
    o = function (t, e) {
      var s,
        ...
        s.length && s !== r && s[0] && s[0].style && !s.nodeType && (s = s[0]),
        s === r || (s.nodeType && s.style) ? s : null).getBoundingClientRect(),
    ...
    i = function (t, e, s) {
      var i = typeof t;
      return isNaN(t)
        ? "number" === i || ("string" === i && "=" === t.charAt(1))
          ? t
          : "max" === t
          ? n(e, s)
          : Math.min(n(e, s), o(t, e)[s])
        : parseFloat(t);
    },
    p = _gsScope._gsDefine.plugin({
      ...
      set: function (t) {
        ...
        this.x < 0 && (this.x = 0),
          ...
          this._wdw
            ? r.scrollTo(this.skipX ? e : this.x, this.skipY ? s : this.y)
...
!(function (f, c) {
  ...
  if (!m.TweenLite) {
    var t,
      ...
      b = function (o, l, h, _) {
        (this.sc = P[o] ? P[o].sc : []),
          ((P[o] = this).gsClass = null),
          (this.func = h);
        var u = [];
        (this.check = function (t) {
          for (var e, i, s, n, r = l.length, a = r; -1 < --r; )
            (e = P[l[r]] || new b(l[r], [])).gsClass
              ? ((u[r] = e.gsClass), a--)
              : t && e.sc.push(this);
          if (0 === a && h) {
            if (
              ((s = (i = ("com.greensock." + o).split(".")).pop()),
              (n = g(i.join("."))[s] = this.gsClass = h.apply(h, u)),
              _)
            )
              if (
                ((m[s] = p[s] = n),
                ...
                if (o === c)
                  for (r in ((module.exports = p[c] = n), p)) n[r] = p[r];
                else p[c] && (p[c][s] = n);
              else
                "function" == typeof define &&
                  define.amd &&
    ...
    var o = [0, 0, 1, 1],
      ...
      h = (S.register = function (t, e, i, s) {
        for (
          ...
          for (
            r = l[h],
              n = s ? k("easing." + r, null, !0) : u.easing[r] || {},
              a = _.length;
            -1 < --a;
    ...
    for (
      ...
      (i = t[e] + ",Power" + e),
        h(new S(null, null, 1, e), i, "easeOut", !0),
        h(new S(null, null, 2, e), i, "easeIn" + (0 === e ? ",easeNone" : "")),
        h(new S(null, null, 3, e), i, "easeInOut");
        ...
        if (this._timeline) {
          ...
          this._gc && this._enabled(!0, !1),
            (this._totalTime === t && 0 !== this._duration) ||
              (U.length && Y(), this.render(t, e, !1), U.length && Y());
        }
        return this;
      }),
    ...
    var z = k(
        ...
        function (t, e, i) {
            ...
            for (
              ...
              (n = r[s])
                ? "string" != typeof n
                  ...
                  : "string" == typeof (n = r[s--] = z.selector(n)) &&
                    r.splice(s + 1, 1)
                : r.splice(s--, 1);
          else
            (this._propLookup = {}),
          ...
          (this.vars.immediateRender ||
            ...
            ((this._time = -T), this.render(Math.min(0, -this._delay)));
        },
        !0
      ),
      F = function (t) {
    ...
    (W._startTime = d.time),
      ...
      setTimeout(Y, 1),
      (_._updateRoot = z.render =
        function () {
          var t, e, i;
          if (
            (U.length && Y(),
            W.render((d.time - W._startTime) * W._timeScale, !1, !1),
            V.render((d.frame - V._startTime) * V._timeScale, !1, !1),
            U.length && Y(),
            d.frame >= X)
          ) {
            for (i in ((X = d.frame + (parseInt(z.autoSleep, 10) || 120)), $)) {
              for (t = (e = $[i].tweens).length; -1 < --t; )
    ...
    var Z = function (t, e, i) {
        var s,
          ...
          r = t._gsTweenID;
        if (
          ($[r || (t._gsTweenID = r = "t" + K++)] ||
            ($[r] = { target: t, tweens: [] }),
          e && (((s = $[r].tweens)[(n = s.length)] = e), i))
        )
      ...
      it = function (t, e, i) {
        ...
        return e < (r /= n)
          ? r - e
          : (i && r === e) || (!t._initted && r - e < 2 * T)
          ? T
          : (r += t.totalDuration() / t._timeScale / n) > e + T
          ? 0
          : r - e - T;
      };
    (i._init = function () {
      ...
      (i._initProps = function (t, e, i, s, n) {
        ...
        this.vars))
          if (((_ = this.vars[r]), H[r]))
            _ &&
              (_ instanceof Array || (_.push && w(_))) &&
              -1 !== _.join("").indexOf("{self}") &&
              (this.vars[r] = _ = this._swapSelfInParams(_, this));
          else if (
            B[r] &&
            (l = new B[r]())._onInitTween(t, this.vars[r], this, n)
          ) {
            for (
              this._firstPT = h =
                {
        ...
        if (l - 1e-7 <= t && 0 <= t)
          (this._totalTime = this._time = l),
            ...
            0 === l &&
              ...
              (h < 0 ||
                (t <= 0 && -1e-7 <= t) ||
                (h === T && "isPause" !== this.data)) &&
                h !== t &&
                ((i = !0), T < h && (n = "onReverseComplete")),
      ...
      (z.killTweensOf = z.killDelayedCallsTo =
        function (t, e, i) {
          ...
          for (var s = z.getTweensOf(t, e), n = s.length; -1 < --n; )
            s[n]._kill(i, t);
        });
    var st = k(
      "plugins.TweenPlugin",
    ...
    if (
      ...
      (a.plugin = function (t) {
        ...
        for (e in (((o.constructor = a).API = t.API), r))
      ...
      for (i in P)
        P[i].func || f.console.log("GSAP encountered missing dependency: " + i);
    }
    v = !1;
  }
})(
...
!(function (e, n) {
  ...
  (l.configure = function (e) {
    ...
    (l.inc = function (e) {
      ...
      return n
        ? ("number" != typeof e &&
            (e = (1 - n) * r(Math.random() * n, 0.1, 0.95)),
          (n = r(n + e, 0, 0.994)),
          l.set(n))
        : l.start();
    }),
    ...
    (l.render = function (e) {
      ...
      return (
        ...
        d.showSpinner || ((t = n.querySelector(d.spinnerSelector)) && c(t)),
  ...
  var i = (function () {
    ...
    m = (function () {
        ...
        (r = (r = n)
          ...
          (n =
            ...
            (i[r] = (function (e) {
              ...
              if (e in n) return e;
              for (
                var t, r = s.length, i = e.charAt(0).toUpperCase() + e.slice(1);
                r--;
      ...
      return function (e, n) {
        ...
        if (2 == i.length)
          for (t in n)
            void 0 !== (r = n[t]) && n.hasOwnProperty(t) && o(e, t, r);
        else o(e, i[1], i[2]);
      };
    })();
  function s(e, n) {
...
var Variables = {
  ...
  isLocalhost:
    ...
    "8888" == window.location.port,
  init: function () {
    (Variables.animEaseOut = window.Quart.easeOut),
      (Variables.animEaseIn = window.Quart.easeIn),
      (Variables.animEaseInOut = window.Quart.easeInOut);
  },
  ...
  getWindowInnerHeight: function () {
    ...
    return (
      e.style.setProperty("--app-height", n + "px"),
      e.style.setProperty("--app-half-height", 0.5 * n + "px"),
      1 * n
    );
  },
};
var Helper = (function () {
  ...
  return (
    ...
    (c.checkAppHREF = function (e) {
      return (
        -1 != e.indexOf(window.location.origin) &&
          (e = e.split(window.location.origin)[1]),
        "/" != e.substr(0, 1) && (e = "/" + e),
        e
      );
    }),
    ...
    (c.bindSelfClicks = function (e, n) {
      for (
        var r = e.querySelectorAll("a[target=_self]"), l = 0;
        l < r.length;
        l++
      ) {
        var t = r[l];
        (t.callback = n || c.HTMLAnchorClick.bind(t)),
          t.addEventListener("click", t.callback, !1);
      }
    }),
    (c.unbindSelfClicks = function (e) {
      for (
        var n = e.querySelectorAll("a[target=_self]"), r = 0;
        r < n.length;
        r++
      ) {
        var l = n[r];
...
var Router = {
  ...
  config: function (t) {
    return (
      (this.mode =
        t &&
        t.mode &&
        ("history-push" == t.mode || "history-replace" == t.mode) &&
        history.pushState
          ? t.mode
          : "hash"),
      (this.root = t && t.root ? "/" + this.clearSlashes(t.root) + "/" : "/"),
      this
    );
  },
  getFragment: function () {
    var t = "";
    if ("history-push" === this.mode || "history-replace" === this.mode)
      (t = this.clearSlashes(decodeURI(location.pathname + location.search))),
  ...
  add: function (t, e) {
    return (
      ...
      this.routes.push({ re: t, handler: e }),
      this
    );
  },
  remove: function (t) {
    for (var e, r = 0; this.routes.length, (e = this.routes[r]); r++)
      if (e.handler === t || e.re.toString() === t.toString())
        return this.routes.splice(r, 1), this;
    return this;
  },
  flush: function () {
...
var RouterExtensionEvents = {
    FETCHED: "re-on-fetched",
    PRE_FETCH: "re-pre-fetch",
    ROUTE_CHANGE: "re-on-route-change",
    HASH_CHANGE: "re-on-hash-change",
  },
  RouterExtension = (function () {
    function n() {
      var e = this;
      (this.firstCheckDone = !1),
        (this.response = ""),
        (this.pageType = ""),
        (this.oldPageType = "");
    ...
    return (
      ...
      (n.prototype.onHashChange = function (e) {
        document.dispatchEvent(
          new CustomEvent(RouterExtensionEvents.HASH_CHANGE, {
      ...
      (n.prototype.handleRoute = function () {
        ...
        if (
          ...
          document.dispatchEvent(
            new CustomEvent(RouterExtensionEvents.PRE_FETCH, { detail: this })
          ),
          ...
          document.dispatchEvent(
            new CustomEvent(RouterExtensionEvents.ROUTE_CHANGE, {
              detail: this,
            })
          ),
            this.xhr
              ...
              : ((this.xhr = new XMLHttpRequest()),
                this.xhr.addEventListener(
                  "load",
                  this.onNewPageFetched.bind(this),
                  !1
                ));
          var t = Router.getFragment();
          this.xhr.open("GET", "/" !== t.substr(0, 1) ? "/" + t : t, !0),
      ...
      (n.prototype.onNewPageFetched = function (e) {
        200 == this.xhr.status
          ? ((this.response = this.xhr.response), this.handleNewPage())
      ...
      (n.prototype.handleNewPage = function () {
        if (this.isInitialState)
          ...
          for (t.innerHTML = this.response; t.firstChild; )
            e.appendChild(t.firstChild),
              t.firstChild &&
                t.firstChild.id &&
                "app-page" === t.firstChild.id &&
                (this._element = t.firstChild.children[0]);
        }
        (this.pageType = this.element.getAttribute("page-type")),
          this.isInitialState ||
            this.pageType !== PageTypes.HOME ||
            (this.pageType = PageTypes.CLIENTS),
          this.oldPageType &&
            document.body.classList.remove("page-type--" + this.oldPageType),
          document.body.classList.remove("page--loading"),
          document.body.classList.add("page-type--" + this.pageType),
          document.dispatchEvent(
            new CustomEvent(RouterExtensionEvents.FETCHED, { detail: this })
          ),
...
var BasicAppView = (function () {
  function e(e) {
    e && e.el && this.setEl(e.el),
      ...
      document.addEventListener(
        RouterExtensionEvents.HASH_CHANGE,
        this.onHashChangeCallback,
        !1
      ),
      (this.onRouteContentFetchedCallback =
        this.onRouteContentFetched.bind(this)),
      document.addEventListener(
        RouterExtensionEvents.FETCHED,
        this.onRouteContentFetchedCallback,
        !1
      ),
      (this.onRouteChangeCallback = this.onRouteChange.bind(this)),
      document.addEventListener(
        RouterExtensionEvents.ROUTE_CHANGE,
  ...
  return (
    (e.prototype.setEl = function (e) {
      this.el && Helper.unbindSelfClicks(this.el),
        (this.el = e),
  ...
  return (
    ...
    (e.prototype.animateOut = function (e) {
      if (this.el) {
        ...
        for (
          var t = this.el.querySelectorAll("img[preliminary-load]"), i = 0;
          i < t.length;
          i++
        )
          t[i].removeEventListener("load", this.preliminaryLoadCallback, !1);
    ...
    (e.prototype.animateIn = function () {
      (this.wantsToAnimateIn = !0),
        this.hasPreliminaryLoaded &&
          (document.getElementById("app-page").classList.add("page-loaded"),
    ...
    (e.prototype.onPreliminaryLoaded = function (e) {
      this.preliminaryToLoad--,
        (this.hasPreliminaryLoaded = this.preliminaryToLoad <= 0),
        this.hasPreliminaryLoaded &&
          this.wantsToAnimateIn &&
          !this.animatingIn &&
          (this.pingResize(), this.animateIn());
    }),
...
var __extends =
  ...
  HeaderEvent = {
    HAMBURGER_CLICK: "HeaderEvent-HAMBURGER_CLICK",
    SCROLL_TO_EXPLORE_VISIBILITY_CHANGE:
      "HeaderEvent-SCROLL_TO_EXPLORE_VISIBILITY_CHANGE",
  },
  HeaderView = (function (o) {
    function e(e) {
      ...
      return (
        ...
        document.addEventListener(
          SliderElementEvents.ANIMATED_IN,
          t.onElementsBuild.bind(t),
          !1
        ),
        document.addEventListener(
          SliderElementEvents.FIGURE_ANIMATED_IN,
          t.onElementsBuild.bind(t),
          !1
        ),
        document.addEventListener(
          RouterExtensionEvents.PRE_FETCH,
          t.handlePreFetch.bind(t),
          !1
        ),
        document.addEventListener(
          RouterExtensionEvents.FETCHED,
          t.handleNewPage.bind(t),
          !1
        ),
        document.addEventListener(
          ScrollControllerEvents.SCROLLING,
          t.onScrolling.bind(t)
        ),
        t
      );
    }
    return (
      ...
      (e.prototype.onElementsBuild = function (e) {
        ...
        this.el.classList.toggle("show", o),
          (this.canShowScrollToexplore =
            t === PageTypes.HOME || t === PageTypes.PROJECT),
          t === PageTypes.PROJECT &&
            window.innerWidth < 620 &&
            (this.canShowScrollToexplore = !1),
          ...
          [].slice
            ...
            .map(function (e, t) {
              ...
              "/" !== o && -1 !== n.indexOf(o)
                ...
                : "/" !== o ||
                  (n !== o && -1 === n.indexOf("editorial")) ||
                  e.classList.add("active-semi"),
                e.getElementsByTagName("a")[0].getAttribute("href") === n &&
      ...
      (e.prototype.onScrolling = function (e) {
        ...
        t.position < ScrollController.maxMin - 10 && this.showScrollToExplore
          ? this.toggleScrollToExplore(!1)
          : t.position > ScrollController.maxMin - 10 &&
            !this.showScrollToExplore &&
            this.canShowScrollToexplore &&
            this.toggleScrollToExplore(!0);
      }),
      (e.prototype.toggleScrollToExplore = function (e) {
        e
          ? (document.body.classList.add("scroll-to-explore--show"),
            document.dispatchEvent(
              new CustomEvent(HeaderEvent.SCROLL_TO_EXPLORE_VISIBILITY_CHANGE, {
                detail: !0,
              })
            ))
          : (document.body.classList.remove("scroll-to-explore--show"),
            document.dispatchEvent(
              new CustomEvent(HeaderEvent.SCROLL_TO_EXPLORE_VISIBILITY_CHANGE, {
                detail: !1,
              })
            )),
          e && this.canShowScrollToexplore
            ? this.hamburgerLine.classList.add("show")
            : this.hamburgerLine.classList.remove("show"),
  ...
  return (
    ...
    (t.prototype.draw = function () {
      ...
      for (var t = 0; t < this.points.length; t += 2) {
        var i = this.points[t],
          e = this.points[t + 1];
        this.ctx.arc(this.el.width * i, this.el.height * e, 10, 0, 0, !1),
...
var __extends =
  ...
  SliderContentPage = (function (n) {
    function t(t) {
      ...
      return (
        (e.animOutTimer = 0),
        (e.closeButton = e.el.querySelector('button[type="close"]')),
        e.closeButton &&
          ((e.closeCallback = e.onCloseClick.bind(e)),
          e.closeButton.addEventListener("click", e.closeCallback, !1)),
        e
      );
    }
    return (
      ...
      (t.prototype.animateIn = function () {
        n.prototype.animateIn.call(this),
          this.closeButton && this.closeButton.classList.add("animate-in"),
          this.el
            .getElementsByClassName("slider-content")[0]
...
var __extends =
  ...
  ClientsPage = (function (n) {
    function t(t) {
      var e = n.call(this, t) || this;
      return (
        (e.sliderUi = new SliderUI({
          el: e.el.getElementsByClassName("slider-ui")[0],
        })),
        e
      );
    }
...
var __extends =
  ...
  ExplorePage = (function (l) {
    function t(t) {
      ...
      (e._scrolled = !1),
        (e.listAnimtingIn = !1),
        (e.onTypeButtonClickCallback = e.onTypeButtonClick.bind(e));
      for (
        var i = 0, n = [].slice.call(e.el.querySelectorAll("menu button"));
        i < n.length;
        i++
      ) {
    ...
    return (
      ...
      (t.prototype.onListItemClick = function (t) {
        ...
        var e = Helper.checkAppHREF(t.currentTarget.getAttribute("href")),
          i = t.currentTarget;
        (this.elementToAnimateOutTo = i).parentNode.classList.add("selected"),
          this.activeList.classList.add("disabled"),
          Router.navigate(e);
      }),
      ...
      Object.defineProperty(t.prototype, "listType", {
        ...
        set: function (t) {
          var e = this;
          (this._listType = t),
            (this.activeList = this.el.querySelector(
              ".lists ul.list-" + this._listType
            ));
          ...
          gsap.TweenLite.set(this.activeList, {
            force3D: !0,
            x: window.innerWidth - n,
          }),
      ...
      (t.prototype.onCustomScrolling = function (t) {
        var e = t.detail;
        (this.scrolled = e.position < -10),
          this.listAnimtingIn ||
            gsap.TweenLite.set(this.activeList, { force3D: !0, x: e.position });
      }),
      (t.prototype.onTypeButtonClick = function (t) {
        for (
          var e = this, i = 0;
          i < this.el.querySelectorAll("menu button").length;
          i++
        ) {
          this.el
      ...
      (t.prototype.onOldTypeAnimatedOut = function (t) {
        window.app.scrollController.reset(),
          this.el.querySelector(".lists").setAttribute("type", t),
          (this.listType = t);
      }),
      (t.prototype.onResize = function (t) {}),
      (t.prototype.animateOut = function (t) {
        ...
        if ((l.prototype.animateOut.call(this), this.elementToAnimateOutTo)) {
          ...
          gsap.TweenLite.to(
            this.elementToAnimateOutTo,
            0.5 * Variables.animTime,
            {
      ...
      (t.prototype.dealloc = function () {
        ...
        for (
          var t = 0, e = [].slice.call(this.el.querySelectorAll("menu button"));
          t < e.length;
          t++
        ) {
...
var __extends =
  ...
  ExploreResultPage = (function (e) {
    function o(o) {
      ...
      return (
        (t.colorBox = t.el.getElementsByClassName("color-box")[0]),
        (t.colorBoxLeft = 0),
        t
      );
    }
    return (
      ...
      (o.prototype.onResize = function (o) {
        e.prototype.onResize.call(this, o),
          this.colorBox && (this.colorBoxLeft = this.colorBox.offsetLeft);
      }),
      (o.prototype.onCustomScrolling = function (o) {
        var t = o.detail;
        if (this.colorBox) {
          var e = Math.abs(t.position) / 50;
          0 === this.colorBoxLeft && this.onResize(null),
            gsap.TweenLite.set(this.colorBox, {
              force3D: !0,
              x: e * this.colorBoxLeft * -1,
            });
        }
      }),
      o
...
var MouseFollow = (function () {
  function e() {
    ...
    (this.bindTimer = 0),
      ...
      (this.onBunksChange = function () {
        ...
        if (-1 !== [PageTypes.HOME, PageTypes.CLIENTS].indexOf(e)) {
          (i.canSet = !0),
            i.removeBunks(),
            (i.bunkElements = document.getElementsByClassName("image"));
          for (var n = 0; n < i.bunkElements.length; n++) {
            var t = i.bunkElements[n];
            t.addEventListener("mouseenter", i.onBunkElementEnter, !1),
              t.addEventListener("mouseover", i.onBunkElementEnter, !1),
              t.addEventListener("mouseleave", i.onBunkElementLeave, !1);
          }
      ...
      (this.onMouseMove = function (e) {
        FigureElementForBunk.inScaleMode
          ? (i.bunkOver = !1)
          : ((i.vector = relax.geom.getXYFromMouseTouchEvent(e)),
            gsap.TweenLite.set(i.el, {
              force3D: !0,
              x: i.vector.x,
              y: i.vector.y,
            }));
    ...
    e.classList.add("inner"),
      ...
      document.addEventListener(
        SliderElementEvents.ORDER_CHANGED,
        this.onBunksChange,
        !1
      );
  }
  return (
    (e.prototype.removeBunks = function () {
      if (this.bunkElements)
        for (var e = 0; e < this.bunkElements.length; e++) {
          ...
          n.removeEventListener("mouseenter", this.onBunkElementEnter, !1),
            n.removeEventListener("mouseover", this.onBunkElementEnter, !1),
            n.removeEventListener("mouseleave", this.onBunkElementLeave, !1);
        }
    }),
    Object.defineProperty(e.prototype, "bunkOver", {
      ...
      set: function (e) {
        if (
          ((!this.vector || (0 === this.vector.x && 0 === this.vector.y)) &&
            (e = !1),
          (this._bunkOver = e),
          this.canSet)
        ) {
          ...
          e
            ? (gsap.TweenLite.to(n, 0.35 * Variables.animTime, {
              ...
              this.el.classList.add("bunk--zoomin"))
            : (gsap.TweenLite.to(n, 0.35 * Variables.animTime, {
                ease: Variables.animEaseOut,
                force3D: !0,
                scale: 0,
...
var ScrollControllerEvents = {
    SCROLLED: "ScrollControllerEvents-SCROLLED",
    SCROLLING: "ScrollControllerEvents-SCROLLING",
  },
  ScrollController = (function () {
    function e() {
      (this.yPosition = 0),
        ...
        (this.disabled = !1),
        (this.scrollingTo = !1),
        (this._hasInitScrolled = !1),
        (this.yAcceleration = 0),
        this.reset();
      var t =
          relax.browser.isTouch() &&
          (relax.browser.isMobile() || relax.browser.isTablet()),
    ...
    return (
      Object.defineProperty(e.prototype, "hasInitScrolled", {
        ...
        set: function (t) {
          (this._hasInitScrolled = t) &&
            document.body.classList.add("init-scrolled");
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(e.prototype, "yTarget", {
        ...
        set: function (t) {
          (this._yTarget = Math.min(e.maxMin, t)),
            0 !== e.minMin &&
              (this._yTarget = Math.max(this._yTarget, e.minMin));
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(e.prototype, "xTarget", {
        ...
        set: function (t) {
          (this._xTarget = Math.min(e.maxMin, t)),
            0 !== e.minMin &&
              (this._xTarget = Math.max(this._xTarget, e.minMin));
        },
        enumerable: !0,
        configurable: !0,
      }),
      ...
      (e.prototype.scrollTo = function (t, i) {
        ...
        e !== this.yTarget &&
          ((this.scrollingTo = !i), (this.yTarget = e), this.render());
      }),
      ...
      (e.prototype.handleNewPage = function () {
        ...
        var t = window.app.router.pageType;
        (this.sliderElements &&
          this.sliderElements.ignorePageChange &&
          t === PageTypes.PROJECT) ||
          this.reset(),
          (this.disabled = t === PageTypes.CONTACT);
        var i = window.app.router;
        this.sliderElements ||
          (this.sliderElements = new SliderElements({
            infinite:
              -1 === [PageTypes.CONTACT, PageTypes.EXPLORE_RESULT].indexOf(t),
          })),
          this.sliderElements.update(i.response);
      }),
      (e.prototype.onVirtualScroll = function (t) {
        if (Application.introDone && !this.scrollingTo && !this.disabled) {
          ...
          (this.xTarget = e),
            window.innerWidth <= 1024 && (this.yTarget = this.xTarget),
      ...
      (e.prototype.render = function () {
        ...
        this.rAf && cancelAnimationFrame(this.rAf),
          (this.scrollYDirection =
            this.yTarget < this.yPosition
              ? 1
              : this.yTarget > this.yPosition
              ? -1
              : 0),
          (this.scrollXDirection =
        ...
        (this.yAcceleration += 0.2 * (i - this.yAcceleration)),
          this.sliderElements && this.sliderElements.setX(this.yPosition);
        ...
        e
          ...
          : ((this.rAf = null),
            document.dispatchEvent(
              new CustomEvent(ScrollControllerEvents.SCROLLED)
            )),
          document.dispatchEvent(
            new CustomEvent(ScrollControllerEvents.SCROLLING, { detail: this })
          ),
          this.position < -100 &&
            !this.hasInitScrolled &&
            (this.hasInitScrolled = !0),
  ...
  SliderUI = (function (n) {
    function e(e) {
      ...
      return (
        ...
        document.addEventListener(
          SliderElementsEvents.ELEMENTS_BUILD,
          t.onElementsBuildCallback,
          !1
        ),
        document.addEventListener(
          SliderElementsEvents.FOCUS_INDEX_UPDATE,
          t.onFocusIndexUpdateCallback,
          !1
        ),
        t
      );
    ...
    return (
      ...
      (e.prototype.dealloc = function () {
        document.removeEventListener(
          SliderElementsEvents.ELEMENTS_BUILD,
          this.onElementsBuildCallback,
          !1
        ),
          document.removeEventListener(
            SliderElementsEvents.FOCUS_INDEX_UPDATE,
            this.onFocusIndexUpdateCallback,
            !1
          ),
      ...
      (e.prototype.onKeyUp = function (e) {
        39 === e.keyCode
          ? document.dispatchEvent(
              new CustomEvent(SliderUIEvents.MENU_BUTTON_CLICK, { detail: !0 })
            )
          : 37 === e.keyCode &&
            document.dispatchEvent(
              new CustomEvent(SliderUIEvents.MENU_BUTTON_CLICK, { detail: !1 })
            );
      }),
        ...
        set: function (e) {
          ...
          this.indexSpan &&
            ...
            gsap.TweenLite.to(t, 0.25 * Variables.animTime, {
              ...
              onComplete: function () {
                try {
                  for (; 1 < t.parentNode.children.length; )
                    t.parentNode.removeChild(t.parentNode.children[0]);
                } catch (e) {}
              },
            })),
            (e += 1);
          ...
          (this.indexSpan = document.createElement("span")),
            (this.indexSpan.innerHTML =
              1 == e.toString().length ? "0" + e.toString() : e.toString()),
            this.indexSpan &&
              i &&
              (i.appendChild(this.indexSpan),
              gsap.TweenLite.set(this.indexSpan, {
                force3D: !0,
                y: -10,
                opacity: 0,
              }),
              gsap.TweenLite.to(this.indexSpan, 0.25 * Variables.animTime, {
                ease: Variables.animEaseOut,
                force3D: !0,
                delay: n,
                y: 0,
...
var __extends =
  ...
  SliderInfo = (function (a) {
    function i(t) {
      ...
      (n.text = ""),
        (n.currentCategoryText = "&thinsp;QI AN"),
      ...
      return (
        ...
        document.addEventListener(
          ...
          function (t) {
            var e = t.detail;
            (n.currentCategoryText = e
              .getCurrentDataset()
              .getAttribute("data-client")),
              (n.currentCategoryNumChildren = e
                .getCurrentDataset()
                .getAttribute("data-length")),
              n.showingBranding || n.updateData(n.currentCategoryText, !1);
          }
        ),
        document.addEventListener(
          SliderElementsEvents.FOCUS_INDEX_UPDATE,
        ...
        Application.introDone
          ? ((n.hasSetupForIntro = !0), n.onPageChange())
          : n.animateInForIntro(),
        n
      );
    }
    return (
      ...
      (i.prototype.animateInForIntro = function () {
        ...
        (this.showingBranding = !0),
          this.updateData("&thinsp;QI AN", !0, "一个独立摄影师", function () {
            (t.hasSetupForIntro = !0),
              t.introWantsToAnimateInRequestd && t.slideIntrotToPlace();
          }),
          setTimeout(function () {
      ...
      (i.prototype.slideIntrotToPlace = function () {
        document.body.classList.add("show"),
          Application.onIntroStart(),
          (this.isShowingIntroScreen = !1),
          this.introBunkCallback();
        for (
          var t = 3,
            e = this.el.getElementsByClassName("left")[0],
            n = (e = e.children[e.children.length - 1]).getElementsByClassName(
              "item"
            ),
            a = 0;
          a < n.length;
      ...
      (i.prototype.animateIntroSpansIn1 = function () {
        ...
        for (
          var n = 0.034 * window.innerWidth,
            a = 0.5 * window.innerWidth - n,
            i = e.getElementsByClassName("item"),
            o = 0,
            r = [77, 77, 85],
            s = [57, 57, 66],
            l = 0;
          ...
          var p = i[l];
          gsap.TweenLite.set(p, {
            force3D: !0,
            opacity: 0,
            x:
              a +
              (p.classList.contains("subtitle")
                ? 768 < window.innerWidth
                  ? -40
                  : -30
                : -0.5 * (768 < window.innerWidth ? r[l] : s[l])),
            y: -30,
          }),
            gsap.TweenLite.to(p, Variables.animTime, {
              ...
              y: 0,
              onComplete: function () {
                (t.isShowingIntroScreen = !0),
                  t.introBunkCallback &&
                    0 == o++ &&
                    (t.introBunkCallback(), t.slideIntrotToPlace());
              },
            });
        }
      }),
      (i.prototype.introWantsToAnimateIn = function (t) {
        (this.introBunkCallback = t),
          (this.introWantsToAnimateInRequestd = !0),
          this.isShowingIntroScreen && this.slideIntrotToPlace();
      }),
      (i.prototype.onPageChange = function () {
        ...
        (this.canShowLogoType =
          ...
          t === PageTypes.CONTACT),
          this.canShowLogoType &&
            this.updateData("&thinsp;QI AN", !0, "一个独立摄影师");
      }),
      (i.prototype.onCustomScrolling = function (t) {
        var e = t.detail;
        this.canShowLogoType &&
          (e.position >= Math.round(ScrollController.maxMin) - 20
            ? this.showingBranding ||
              this.updateData("&thinsp;QI AN", !0, "一个独立摄影师")
            : e.position < Math.round(ScrollController.maxMin) &&
              this.showingBranding &&
              this.updateData(this.currentCategoryText, !1));
      }),
        ...
        if (((this.showingBranding = e), t && this.text !== t)) {
          ...
          var o = document.createElement("div"),
            r =
              ...
              t
                .split(" ")
                .join('</span><span class="item ' + (e && "branding") + '">') +
              " </span>\n            ";
          if (
            (n && (r += "<span class='item subtitle'>" + n + "</span>"),
            (o.innerHTML = r),
            i.appendChild(o),
            (this.text = t),
            !e)
      ...
      (i.prototype.animateSpansIn = function (t, e) {
        if ((void 0 === e && (e = 0), Application.introDone))
          for (
            var n = this.el.getElementsByClassName("left")[0],
              a = (n =
                n.children[n.children.length - 1]).getElementsByClassName(
                "item"
              ),
              i = a.length,
              o = 0;
            ...
            gsap.TweenLite.set(r, { force3D: !0, y: -30, opacity: 0 }),
              gsap.TweenLite.to(r, 0.5 * Variables.animTime, {
                ease: Variables.animEaseOut,
                delay:
                  e + (Application.introDone ? 0 : 1) + 0.04 * (a.length - o),
                force3D: !0,
                opacity: 1,
                y: 0,
                onComplete: function () {
          ...
          for (var t = 0; t < r.length; t++)
            (o = t),
              (function () {
                for (
                  var t = r[o],
                    e = t.getElementsByClassName("item"),
                    n = e.length,
                    a = 0;
                  a < e.length;
                  a++
  ...
  SliderElement = (function () {
          ...
          return function (e) {
            t.classList.remove("lazyload"),
              t.parentNode.parentNode
                .getElementsByClassName("exoskelet")[0]
    ...
    return (
      ...
      Object.defineProperty(e.prototype, "inView", {
        ...
        set: function (e) {
          e && !this.el.classList.contains("in-view")
            ? this.el.classList.add("in-view")
            : !e &&
              this.el.classList.contains("in-view") &&
              this.el.classList.remove("in-view"),
            (this._inView = e) || this.figureElement.hide();
        },
        enumerable: !0,
        configurable: !0,
      }),
      (e.prototype.setWidth = function () {
        if (this.figureElement) {
          ...
          var e = 0;
          if (!!this.el.getElementsByClassName("case-elements")[0])
            (e = this.figureElement.getWidth()), (this._elementWidth = e);
          else {
            for (
              var t = this.el.getElementsByClassName("bunk-element"), i = 0;
              i < t.length;
              i++
            ) {
              e += t[i].offsetWidth;
            ...
            this._elementWidth =
              e + (this.isAbsolutlyFirstChildWithPadding() ? 0 : n);
          }
          (this._elementWidth = Math.max(700, this._elementWidth)),
            (this.el.style.minWidth = this._elementWidth + "px");
        }
      }),
      ...
      (e.prototype.calcX = function (e) {
        (this.left = e),
          ...
          (this.leftFromScreenPercent =
            (this.left + this.paddingLeft) / window.innerWidth),
          this.figureElement &&
            (this.isAbsolutlyFirstChildWithPadding()
              ? this.figureElement.onXUpdate(
                  this.leftFromScreenPercent,
                  this.left + this.paddingLeft,
                  this.maxPadding
                )
              : this.figureElement.onXUpdate(
                  this.centerFromScreenPercent,
                  this.left + this.paddingLeft,
                  this.maxPadding,
                  this.canAllScale
                )),
          (this.centerFromScreenPercent = Math.min(
            1,
            Math.max(0, this.centerFromScreenPercent)
          )),
          (this.leftFromScreenPercent = Math.min(
            1,
            Math.max(0, this.leftFromScreenPercent)
          ));
      }),
      ...
      (e.prototype.calcPaddingLeft = function () {
        if (this.limitPaddingToFirstChild && !this.isFirstCreatedElement)
          this.paddingLeft = 0;
        else {
          var e = 1.15 * this.maxPadding;
          (this.paddingLeft = Math.min(1, Math.max(0, 1 - this.left / e))),
            (this.paddingLeft *= this.maxPadding);
        }
      }),
      (e.prototype.unbindATags = function () {
        if (this.anchorEls) {
          for (var e = 0; e < this.anchorEls.length; e++) {
            this.anchorEls[e].removeEventListener(
              "click",
              this.clickCallback,
              !0
            );
      ...
      (e.prototype.bindATags = function () {
        if (
          (this.unbindATags(),
          (this.anchorEls = this.el.querySelectorAll("a[target=_self]")),
          this.anchorEls && 0 < this.anchorEls.length)
        ) {
      ...
      (e.prototype.onClick = function (e) {
        ...
        var t = window.app.scrollController.yTarget - ScrollController.maxMin,
          i = Math.abs(t) < 10;
        if (this.isAbsolutlyFirstChildWithPadding() && i)
          document.dispatchEvent(
            new CustomEvent(SliderUIEvents.MENU_BUTTON_CLICK, { detail: !0 })
          );
        else {
          (FigureElementForBunk.esID = e.currentTarget.getAttribute("data-id")),
            this.controller.setElementInFocus(this);
      ...
      (e.prototype.setupFigure = function (e, t) {
        void 0 === e && (e = !1),
          void 0 === t && (t = !1),
          this.figureElement &&
            (this.figureElement.dealloc(), (this.figureElement = null)),
          0 < this.el.getElementsByClassName("bunk-element").length
            ? (this.figureElement = new FigureElementForBunk({
                el: this.el,
                canAnimatedIn: t,
                sliderElement: this,
                controller: this.controller,
                isFirstBunkWithPadding: this.isAbsolutlyFirstChildWithPadding(),
              }))
            : ((this.figureElement = new FigureElementForCase({
                el: this.el,
                shuffle: e,
                sliderElement: this,
                controller: this.controller,
              ...
              -1 ===
                [PageTypes.PROJECT, PageTypes.CLIENTS, PageTypes.HOME].indexOf(
                  window.app.router.oldPageType
                ) ||
              -1 !== [PageTypes.CONTACT].indexOf(window.app.router.pageType)
                ? this.animateIn()
                : document.dispatchEvent(
                    new CustomEvent(SliderElementEvents.ANIMATED_IN)
                  ));
      }),
      (e.prototype.animateIn = function () {
        var e = this,
      ...
      (e.prototype.updateContent = function (e, t, i) {
        (this.contentIndex = t),
          (this.isFirstCreatedElement = i),
          this.el != e &&
            this.el.parentNode &&
            (this.el.parentNode.replaceChild(e, this.el),
            (this.el = e),
            this.setupFigure(!1, 0 !== this.left),
            this.bindATags());
        var n =
            this.el.classList.contains("bunk--type-aa") ||
            this.el.classList.contains("bunk--type-a"),
          s = window.app.router.pageType === PageTypes.CLIENTS;
        n &&
          s &&
          (this.el.classList.remove("bunk--type-aa"),
          this.el.classList.add("bunk--type-a")),
          n &&
            (this.isFirstCreatedElement &&
              this.limitPaddingToFirstChild &&
              -1 == this.scrollDirection &&
              (this.el.classList.add("bunk--type-aa"),
              this.el.classList.remove("bunk--type-a")),
            this.limitPaddingToFirstChild &&
              1 == this.scrollDirection &&
              (this.el.classList.remove("bunk--type-aa"),
              this.el.classList.add("bunk--type-a"))),
      ...
      (e.prototype.lazyLoadImages = function () {
        ...
        setTimeout(function () {
          for (
            var e = l.el.getElementsByClassName("lazyload"), t = 0;
            t < e.length;
            t++
          ) {
            var i = e[t],
      ...
      (e.prototype.animateOut = function (e) {
        ...
        this.el.removeEventListener("click", this.clickCallback, !0),
          this.figureElement.animateOut(e, function () {
            document.dispatchEvent(
              new CustomEvent(SliderElementEvents.ANIMATED_OUT)
            ),
              t.dealloc();
          });
      }),
      ...
      (e.prototype.onWindowResize = function () {
        this.lazyLoadImages(),
          ...
          this.setWidth(),
          this.figureElement && this.figureElement.onWindowResize();
        var e = Variables.getPaddingRatio();
        (this.maxPadding = window.innerWidth * e),
          this.usePadding && this.calcPaddingLeft();
      }),
      (e.prototype.orderChangedSoChangeContent = function (e) {
        this.onWindowResize(),
          ...
          document.dispatchEvent(
            new CustomEvent(SliderElementEvents.ORDER_CHANGED, { detail: this })
          );
      }),
      (e.MIN_WIDTH = 760),
      e
  ...
  function b(e) {
    (this.headerVisible = !1),
      ...
      this.el.addEventListener(
        relax.animation.getTransitionEndEvent(),
        this.onElAnimatedCallback,
        !1
      ),
      (this.elementScales = []),
      (this.elementXs = []),
    ...
    for (var t = 0; t < this.figures.length; t++) {
      ...
      parseInt(window.getComputedStyle(i).getPropertyValue("height")) >
        window.innerHeight && (i.style.height = window.innerHeight + "px"),
        i.addEventListener("click", this.onFigureAnchorClickCallback, !1);
      var n = window.getComputedStyle(i);
      parseInt(n.getPropertyValue("height"), 10) == window.innerHeight &&
        (i.classList.add("header-open-scale-item"),
        "auto" === n.getPropertyValue("right")
          ? i.classList.add("left-aligned")
          : "auto" === n.getPropertyValue("left") &&
            i.classList.add("right-aligned")),
        (i.style.display = "block");
      var s = i.getElementsByClassName("bunk-element--inner")[0],
        a = s.getBoundingClientRect().height;
      s.setAttribute(
        "ratio",
        ((a / Variables.getWindowInnerHeight()) * 1).toString()
      );
    }
    ScrollController.customScrollEnabled &&
      ((this.onMouseMoveCallback = this.onMouseMove.bind(this)),
      document.addEventListener("mousemove", this.onMouseMoveCallback, !1));
  }
  return (
    ...
    (b.setInScrollMode = function (e) {
      e !== b.inScaleMode &&
        ((b.inScaleMode = e)
          ? document.getElementById("scroll-list").classList.add("disable")
          : document.getElementById("scroll-list").classList.remove("disable"));
    }),
    ...
    (b.prototype.render = function () {
      ...
      if (!this.animatingOut) {
        ...
        this.animatingOut ||
          this.animatingIn ||
          (this.mouseMove += 0.15 * (t - this.mouseMove));
        for (var i = 0, n = 0; n < this.elementScales.length; n++) {
          var s = this.elementScales[n];
          (s.scale += 0.3 * (s.scaleTarget - s.scale)),
            gsap.TweenLite.set(this.figures[n], {
              force3D: !0,
              scale: s.scale,
            });
        }
        ...
        for (n = 0; n < this.elementXs.length; n++) {
          ...
          if (
            !Variables.isMobile &&
            ((g = -100 * (this.mouseMove - 0.5) * m),
            this.elementScales[n] && this.isFirstBunkWithPadding && 0 === n)
          ) {
            var u = 1 - Math.min(1, (this.elementScales[n].scale - 1) / 0.8);
            (g *= u),
              (a = u < 0.1),
              this.elementScales[n].scale - 1 < 0.02
                ? r.classList.remove("scaling")
                : r.classList.add("scaling");
          }
          var d = h.x + g;
        ...
        this.isFirstBunkWithPadding && b.setInScrollMode(a),
          Math.abs(i) < 0.02 &&
          !this.animatingIn &&
          Math.abs(this.mouseMove - t) <= 0.001
            ? (this.rAf = null)
            : (this.rAf = requestAnimationFrame(function () {
                return e.render();
              }));
    ...
    (b.prototype.setxx = function () {
      for (
        var e = window.app.scrollController, t = 0;
        t < this.figures.length;
        t++
      ) {
        var i = this.figures[t].getElementsByClassName(
            "bunk-element--inner"
          )[0],
      ...
      if (
        ...
        for (var a = 0; a < this.figures.length; a++) {
          ...
          if (this.isFirstBunkWithPadding && 0 === a) {
            ...
            this.elementScales[a] ||
              (this.elementScales[a] = {
                scale: Math.max(1, h),
                scaleTarget: Math.max(1, h),
              }),
              (this.elementScales[a].scaleTarget = Math.max(1, h));
          }
        }
        this.hasCurrentLeftBeenSetSoWeCanAnimateIn ||
          ((this.hasCurrentLeftBeenSetSoWeCanAnimateIn = !0),
          this.animateIn(this.canAnimatedIn)),
          this.rAf || this.render();
      }
    }),
      ...
      var c = 0,
        f = function () {
          --c <= 0 &&
            ((e.animatingIn = !1),
            document.dispatchEvent(
              new Event(SliderElementEvents.FIGURE_ANIMATED_IN)
            ));
        };
      this.setxx();
      for (
        var p = Application.checkForIntro(),
          ...
          t = function (e) {
            ...
            if (
              ((w.isInView =
                0 <= v + s && v + s <= Math.max(window.innerWidth, 420)),
              n.classList.add("show"),
              w.isInView || (p && w.isFirstBunkWithPadding))
            )
              if (w.isFirstBunkWithPadding) {
                ...
                if (p) {
                  ...
                  (h = setTimeout(function () {
                    ...
                    0 === e &&
                      (gsap.TweenLite.set(a, {
                        force3D: !0,
                        x:
                          window.innerWidth *
                          Variables.getLowerEndPaddingRatio() *
                          0.75,
                      }),
                      r.complete
                        ? m()
                  ...
                  gsap.TweenLite.set(a, {
                    ...
                    x:
                      window.innerWidth -
                      window.innerWidth * Variables.getPaddingRatio(),
                  }),
                ...
                c++,
                  (s = window.innerWidth),
                  gsap.TweenLite.set(n, { force3D: !0, x: s, opacity: 1 });
                var g = Number(n.getAttribute("ratio")),
                  u =
                    window.innerWidth <= 768
                      ? 0
                      : -100 * (b.mouseMoveTarget - 0.5) * g;
    ...
    (b.prototype.animateOut = function (e, t) {
      ...
      if (e && i) this.animateOutByScalingToCasePosition(t);
        ...
        for (
          var n = this.currentLeft, s = !1, a = 0, r = 0;
          r < this.figures.length;
          r++
        ) {
          var o = this.figures[r],
            ...
            h = l.offsetWidth,
            m =
              (o.getElementsByClassName("bunk-element--inner")[0],
              o.offsetLeft),
    ...
    (b.prototype.animateOutByScalingToCasePosition = function (e) {
      ...
      s &&
        ...
        (this.figures = this.figures.sort(function (e, t) {
          ...
          return i.getAttribute("data-id").toLowerCase() === s
            ? -1
            : n.getAttribute("data-id").toLowerCase() === s
            ? 1
            : 0;
        })));
      for (var t = 0; t < this.figures.length; t++) {
        var i = this.figures[t],
          ...
          m =
            Variables.getWindowInnerHeight() / r.getBoundingClientRect().height,
          g = l - h;
        (g += 0.5 * window.innerWidth * t),
          gsap.TweenLite.to(o, 0.75 * Variables.animTime, {
            ease: Variables.animEaseInOut,
            force3D: !0,
            x: 0,
          }),
          gsap.TweenLite.to(a, 0.75 * Variables.animTime, {
            ease: Variables.animEaseInOut,
            force3D: !0,
            x: g,
            scale: m,
    ...
    (b.prototype.onWindowResize = function () {
      this.reset();
      for (
        var e = this.el.getElementsByClassName("bunk-element"), t = 0;
        t < e.length;
        t++
      ) {
        var i = e[t],
    ...
    (b.prototype.dealloc = function () {
      ...
      for (var e = 0; e < this.figures.length; e++) {
        this.figures[e].removeEventListener(
          "click",
          this.onFigureAnchorClickCallback,
          !1
        );
      }
      (this.onFigureAnchorClickCallback = null),
        (this.rAf = null),
        (this.elementScales = null),
        (this.figures = null);
    }),
    (b.mouseMoveTarget = 0),
    (b.inScaleMode = !1),
...
var FigureElementForCase = (function () {
  function e(e) {
    (this.currentLeft = 0),
      (this.el = e.el),
      (this.shuffleElements = e.shuffle),
      (FigureElementForBunk.esID = void 0);
  }
  return (
    ...
    (e.prototype.setX = function (e) {
      for (var t = 0; t < this.elementVectors.length; t++) {
        ...
        0 < s.right + e && s.left + e < window.innerWidth
          ? (this.caseElements2[t].classList.contains("visible") ||
              this.caseElements2[t].classList.add("visible"),
            gsap.TweenLite.set(this.caseElements2[t], { force3D: !0, x: e }))
          : this.caseElements2[t].classList.contains("visible") &&
            this.caseElements2[t].classList.remove("visible");
      }
    }),
    (e.prototype.render = function () {
      var e = this;
      this.rAf && cancelAnimationFrame(this.rAf);
      for (
        var t = window.app.scrollController, s = 0, i = 0;
        i < this.elementScales.length;
        i++
      ) {
        var n = this.elementScales[i];
        (n.scale += 0.3 * (n.target - n.scale)),
          (s += n.target - n.scale),
          gsap.TweenLite.set(this.caseElementsImages[i], {
            force3D: !0,
            scale: Math.min(1, Math.max(0.5, n.scale)),
          }),
          !t.scrollingTo &&
            t.position < 0 &&
            (0.99 < Math.abs(n.scale)
              ? this.caseElements[i].classList.contains("scaled-up") ||
                this.caseElements[i].classList.add("scaled-up")
              : this.caseElements[i].classList.contains("scaled-up") &&
                this.caseElements[i].classList.remove("scaled-up"));
      }
      this.rAf =
        s < 0.05
          ? null
    ...
    (e.prototype.onXUpdate = function (e, t, s, i) {
      if (
        (void 0 === i && (i = !1), (this.currentLeft = t), !Variables.isMobile)
      ) {
        for (
          var n = window.innerWidth,
            a = n * Variables.getLowerEndPaddingRatio(),
            l = n * Variables.getPaddingRatio(),
            r = n - l,
            o = 0;
          o < this.elementVectors.length;
          o++
        ) {
          this.caseElements[o];
          ...
          this.elementScales[o] ||
            (this.elementScales[o] = { scale: f, target: f }),
            (this.elementScales[o].target = Math.max(0, Math.min(1, f)));
        }
        this.rAf || this.render();
      }
    }),
    ...
    (e.prototype.onWindowResize = function () {
      ...
      for (var i = 0; i < t.length; i++) {
        ...
        this.elementVectors.push({
          ...
          this.caseElements.push(
            n.getElementsByClassName("case-element--inner")[0]
          ),
          this.caseElementsImages.push(
            n.getElementsByClassName("image--outer")[0]
          );
      }
...
var __extends =
  ...
  SliderElementsEvents = {
    FOCUS_INDEX_UPDATE: "SliderElementsEvents-FOCUS_INDEX_UPDATE",
    DATASET_INDEX_UPDATE: "SliderElementsEvents-FOCUS_INDEX_UPDATE",
    ELEMENTS_BUILD: "SliderElementsEvents-ELEMENTS_BUILD",
  },
  SliderElements = (function (n) {
    function d(e) {
      ...
      return (
        ...
        document.addEventListener(
          SliderElementEvents.ORDER_CHANGED,
          t.onElementOrderUpdate.bind(t)
        ),
        document.addEventListener(
          SliderUIEvents.MENU_BUTTON_CLICK,
          t.onSliderUINavButtonClick.bind(t)
        ),
        document.addEventListener(
          SliderElementEvents.ANIMATED_OUT,
          function () {
    ...
    return (
      ...
      (d.prototype.onPreFetch = function (e) {
        ...
        (this.previousPageId = t),
          window.app.router.pageType === PageTypes.CONTACT &&
            this.removeElements();
      }),
      ...
      Object.defineProperty(d.prototype, "focusIndex", {
        ...
        set: function (e) {
          this._focusIndex == e ||
            this.preventFocusIndexUpdate ||
            ((this._focusIndex = e), this.onFocusIndexChanged());
        },
        enumerable: !0,
        configurable: !0,
      }),
      ...
      (d.prototype.update = function (e) {
        var t = window.app.router.pageType,
          n = [
            ...
            PageTypes.CLIENTS,
            PageTypes.PROJECT,
            PageTypes.EXPLORE_RESULT,
            PageTypes.CONTACT,
          ];
        this.ignorePageChange &&
          t !== PageTypes.PROJECT &&
          (this.ignorePageChange = !1),
          (this.infinite =
            t !== PageTypes.CONTACT && t !== PageTypes.EXPLORE_RESULT),
          -1 != n.indexOf(t)
            ? ((this.numberItemsToAnimateOut = 0),
              this.removeElements(),
              0 === this.numberItemsToAnimateOut && this.setupNewElements())
            : this.removeElements();
      }),
        ...
        if (
          (this.elements &&
            this.elements.sort(function (e, t) {
              return e.buildIndex < t.buildIndex
                ? -1
                : e.buildIndex > t.buildIndex
                ? 1
                : 0;
            }),
          (this.ignorePageChange = !1),
      ...
      (d.prototype.render = function (e) {
        if (!this.preventFocusIndexUpdate && this.elements && this.el) {
            ...
            for (var l = 0; l < this.elements.length; l++) {
              (u = this.elements[l]).left + u.elementWidth < 0 && 1 === n
                ? ((this.bump += u.elementWidth),
                  this.bumpIndex++,
                  (ScrollController.maxMin = 0),
                  i.push(i.shift()),
                  u.orderChangedSoChangeContent(n))
                : u.left + u.elementWidth > this.totalSlideWidth &&
                  0 < this.totalSlideWidth &&
                  -1 === n &&
                  (this.elementInFocus.limitPaddingToFirstChild ||
                    (this.bump -= this.elementInFocus.paddingLeft),
                  i.unshift(i.pop()),
                  u.orderChangedSoChangeContent(n),
                  (this.bump -= u.elementWidth),
                  this.bumpIndex--,
                  u.isAbsolutlyFirstChildWithPadding() && (this.bump -= t * a)),
                (ScrollController.maxMin =
                  0 === this.bumpIndex ? -1 * this.bump : 0);
            }
          else
          ...
          (this.elements = i),
            (this.totalSlideWidth = 0),
            this.infinite || (ScrollController.minMin = -1 * (s - t));
          var o,
            r = e,
            d = 0,
            h = 0;
          for (l = 0; l < this.elements.length; l++) {
            ...
            (u.inView = !!p && (h < m && ((o = u), (h = m)), !0)),
              (d += u.elementWidth),
              (this.totalSlideWidth = d);
          }
          if (!this.preventFocusIndexUpdate)
            for (l = 0; l < this.elements.length; l++) {
              (u = this.elements[l]) == o &&
                ((this.elementInFocus = o), (this.focusIndex = u.contentIndex));
            }
          for (l = 0; l < this.elements.length; l++) {
      ...
      (d.prototype.onSliderUINavButtonClick = function (e) {
        ...
        1 === n
          ? (s =
              0 === this.elementInFocus.contentIndex &&
              this.elementInFocus.isAbsolutlyFirstChildWithPadding() &&
              1.1 * t.position > -1 * this.elementInFocus.paddingLeft
                ? -1 * this.elementInFocus.paddingLeft
                : -1 * this.elementInFocus.right)
          : -1 === n &&
            (s = -1 * (this.elementInFocus.left - window.innerWidth)),
          (s += i),
          t.addToTarget(s);
      }),
      (d.prototype.onFocusIndexChanged = function () {
        if (window.app.router.pageType === PageTypes.PROJECT) {
          var e = Helper.checkAppHREF(
            this.elementInFocus.el
              .getElementsByClassName("slide-element--inner")[0]
              .getAttribute("href")
          );
          (this.ignorePageChange = !0),
            (RouterExtension.ignorePageLoading = !0),
            Router.navigate(e);
        }
        document.dispatchEvent(
          new CustomEvent(SliderElementsEvents.FOCUS_INDEX_UPDATE, {
            detail: this,
          })
        );
      }),
      (d.prototype.setupNewElements = function () {
        var e = this;
        (this.preventFocusIndexUpdate = !1),
          !this.ignorePageChange &&
            this.el &&
            this.el.classList.remove("ready");
        var t = window.app.page.el.getElementsByClassName(
          "slide-elements-list"
        )[0];
          ...
          if (!this.ignorePageChange) {
            if (n === PageTypes.PROJECT && FigureElementForBunk.esID) {
              ...
              i.every(function (e, t) {
                if (
                  e.getAttribute("data-id").toLowerCase() !==
                  FigureElementForBunk.esID.toLowerCase()
                )
                  return !0;
      ...
      (d.prototype.onElementOrderUpdate = function (e) {
        if (
          !(
            this.preventFocusIndexUpdate ||
            this.dataset.length <= d.MIN_NUMBER_OF_ITEMS
          )
        ) {
          var t = e.detail,
            n = window.app.scrollController.scrollYDirection;
          if (n) {
            (this.datasetMinIndex += n),
              ...
              this.datasetMaxIndex < 0 &&
                (this.datasetMaxIndex = this.dataset.length - 1),
              this.datasetMinIndex < 0 &&
                (this.datasetMinIndex = this.dataset.length - 1),
              (this.datasetMinIndex = Math.abs(
                this.datasetMinIndex % this.dataset.length
              )),
              (this.datasetMaxIndex = Math.abs(
                this.datasetMaxIndex % this.dataset.length
              )),
              (this.datasetIndex =
                1 == n ? this.datasetMaxIndex : this.datasetMinIndex);
            var i = this.dataset[this.datasetIndex];
            t.updateContent(
              i,
              this.datasetIndex,
              0 === this.datasetIndex && this.bumpIndex <= 1
            );
          }
        }
      }),
        ...
        for (var o = 0; o < l.length; o++) {
          ...
          this.elements.push(
            new SliderElement({
              ...
              index: o,
              canAllScale: n,
              isFirstCreatedElement: 0 === o,
              usePadding: (a && 0 === o) || s,
              limitPaddingToFirstChild: a,
            })
          );
        }
        this.onResize(null),
          document.dispatchEvent(
            new CustomEvent(SliderElementsEvents.ELEMENTS_BUILD, {
              detail: this,
            })
          );
      }),
      ...
      (d.prototype.onResize = function (e) {
        if (this.el) {
          (this.centerVector = new relax.Vector2d(0.5 * window.innerWidth, 0)),
            this.reset();
...
var _this = this,
  ...
  ApplicationEvents = {
    INTRO_DONE: "ApplicationEvents-intro-done",
    PAGE_APPENDED: "ApplicationEvents-PAGE_APPENDED",
  },
    ...
    function s() {
      ...
      -1 != relax.browser.getInternetExplorerVersion() &&
        document.documentElement.classList.add(
          "ie" + relax.browser.getInternetExplorerVersion()
        ),
        relax.browser.isTouch() &&
        (relax.browser.isMobile() || relax.browser.isTablet())
    ...
    return (
      ...
      (s.onIntroDone = function () {
        (s.introDone = !0),
          ...
          document.dispatchEvent(
            new CustomEvent(ApplicationEvents.INTRO_DONE, {})
          );
      }),
      (s.prototype.handleNewPage = function (e) {
        var t,
          ...
          o = e.detail;
        s.introChecked ||
          (o.pageType !== PageTypes.HOME &&
            (s.checkForIntro(), s.onIntroStart(), s.onIntroDone()));
        try {
          window.gtag("config", "UA-132451749-1", {
            page_title: o.pageType,
            page_path: window.location.pathname,
          });
        } catch (e) {}
        var a =
          o.pageType === PageTypes.PROJECT && o.pageType === o.oldPageType;
        o.isInitialState
          ? (t = document
              .getElementById("app-page")
              .getElementsByTagName("main")[0])
          : ((t = o.element),
            a || document.getElementById("app-page").appendChild(t)),
          ...
          document.dispatchEvent(
            new CustomEvent(ApplicationEvents.PAGE_APPENDED, {})
          );
      }),
      (s.prototype.buildNewPage = function (e, t) {
        (this.page &&
          (this.page.type === PageTypes.PROJECT ||
            this.page.type === PageTypes.HOME)) ||
          (e !== PageTypes.PROJECT && PageTypes.HOME);
        switch (e) {
          case PageTypes.PROJECT:
          case PageTypes.CONTACT:
          case PageTypes.DEFAULT:
            this.page = new SliderContentPage({
              el: t,
          ...
          case PageTypes.EXPLORE_RESULT:
            this.page = new ExploreResultPage({
              el: t,
              type: PageTypes.EXPLORE,
            });
            break;
        ...
        for (
          var n = document.getElementById("app-page");
          1 < n.children.length;
      ...
      (s.prototype.resize = function (e) {
        (document.body.style.height = Variables.getWindowInnerHeight() + "px"),
          (document.documentElement.style.height =
            Variables.getWindowInnerHeight() + "px");
      }),
      (s.introDone = !1),
      (s.introChecked = !1),
      s
